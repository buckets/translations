...
const messages:IMessages = {
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n        على الرغم من أن ملء هذا النموذج أفضل، يمكنك أيضًا إرسال بريد إلكتروني إلى bugs@budgetwithbuckets.com\n      ",
    translated: 'auto',
  ...
  "Accept EULA": {
    val: "قبول اتفاقية الترخيص للمستخدم النهائي",
    translated: 'auto',
  ...
  "Accounts in side bar": {
    val: "الحسابات في الشريط الجانبي",
    translated: 'auto',
  ...
  "Allow new connections": {
    val: "السماح بـ الاتصالات الجديدة",
    translated: 'auto',
  ...
  "Amount of money over-allocated in buckets.": {
    val: "كمية المال المخصصة زيادة في الفئات.",
    translated: 'auto',
  ...
  "Attached files are too large.": {
    val: "الملفات المرفقة كبيرة جداً.",
    translated: 'auto',
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "الأفينيوز هي ما تستخدمه لربط أجهزتك معًا حتى تتمكن من إرسال ميزانيتك من جهاز إلى آخر.",
    translated: 'auto',
  ...
  "Break Import Links": {
    val: "قطع روابط الاستيراد",
    translated: 'auto',
    h: "XQYKw3qJ7xKoR/DX6K6NdZxbJLHVJhxy9mFVV8r1ZU4=",
  },
  "Bring All to Front": {
    val: "إحضار الكل إلى الأمام",
    translated: 'auto',
  ...
  "Buckets has crashed.  Please restart after submitting a bug report.": {
    val: "لقد تعطلت Buckets. يرجى إعادة التشغيل بعد إرسال تقرير خطأ.",
    translated: 'auto',
  ...
  "Can't merge budgets of different versions": {
    val: "لا يمكن دمج ميزانيات الإصدارات المختلفة",
    translated: 'auto',
  ...
  "Check for updates": {
    ...
    val: "تحقق من التحديثات",
    translated: 'auto',
    h: "MerO0fg7nnpQBvZ87GDbTKrOJZo+aGSx6qiQEeVAmXw=",
  },
  "Checking for updates...": {
    val: "جاري التحقق من التحديثات...",
    translated: 'auto',
  ...
  "Choose a file ending in either .ynab4 or .ymeta": {
    val: "اختر ملفًا ينتهي بإما .ynab4 أو .ymeta",
    translated: 'auto',
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "اختر أي من الملفات على هذا الجهاز تريد جعله متاحًا لأجهزتك الأخرى.",
    translated: 'auto',
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "الاتصال معطوب. يرجى حذفه وإعادة إنشائه.",
    translated: 'auto',
  ...
  "Do both devices show the same pairing codes?": {
    val: "هل يظهر كلا الجهازين نفس رموز الاقران؟",
    translated: 'auto',
  ...
  "Error decrypting recording": {
    val: "خطأ في فك تشفير التسجيل",
    translated: 'auto',
    h: "6LehLh8oNPMtzfLjQbZAJ3a35TSBoIn+XTBtBBaEuKI=",
  },
  "Error during import": {
    val: "خطأ أثناء الاستيراد",
    translated: 'auto',
  ...
  "If Net is 0, the bucket transactions will be marked as transfers rather than as income or expenses.": {
    val: "إذا كان Net صفرًا، فإن معاملات الدلو ستُصنف كتحويلات بدلاً من كونها دخلاً أو نفقات.",
    translated: 'auto',
  ...
  "Install and Relaunch Buckets": {
    val: "تثبيت وإعادة تشغيل Buckets",
    translated: 'auto',
  ...
  "Invalid categorization.  Categories not set.": {
    val: "تصنيف غير صالح. الفئات غير معينة.",
    translated: 'auto',
  ...
  "Move all transaction memos to blank payee field": {
    val: "نقل جميع مذكرات المعاملات إلى حقل المستفيد الفارغ",
    translated: 'auto',
  ...
  "Nothing found matching:": {
    val: "لم يتم العثور على أي شيء مطابق:",
    translated: 'auto',
  ...
  "Off Budget Accounts": {
    val: "حسابات خارج الميزانية",
    translated: 'auto',
    h: "EQ0I5sn/xpO55GIvIhUF8/XeTi0g5sxvvyE7TiynJDQ=",
  },
  "Off budget": {
    val: "خارج عن الميزانية",
    translated: 'auto',
  ...
  "Or click to download the new version manually.": {
    val: "أو انقر لتنزيل الإصدار الجديد يدويًا.",
    translated: 'auto',
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "أجهزة أخرى قد جعلت الملفات التالية متاحة. اختر المكان الذي تريد حفظها فيه على هذا الجهاز.",
    translated: 'auto',
  ...
  "Overwrite budget from backup": {
    val: "إعادة كتابة الميزانية من النسخة الاحتياطية",
    translated: 'auto',
  ...
  "Permanently delete account and transactions": {
    val: "حذف الحساب والمعاملات نهائيًا",
    translated: 'auto',
  ...
  "Please enter your Buckets License below.": {
    val: "يرجى إدخال رخصة Buckets الخاصة بك أدناه.",
    translated: 'auto',
  ...
  "Sign in to the YNAB website, click My Budget then Export Budget.": {
    val: "قم بتسجيل الدخول إلى موقع YNAB، ثم انقر على ميزانيتي ثم تصدير الميزانية.",
    translated: 'auto',
    h: "etFjjZd2+flhi9J3CbiPL8eb4Gc3jHFAKkMPuQZmxlA=",
  },
  "SimpleFIN Connections": {
    val: "اتصالات SimpleFIN",
    translated: 'auto',
  ...
  "Since some buckets have negative balances, this payment balance may not be what you actually have available for a payment.": {
    val: "بما أن بعض السلال لديها رصيد سلبي، فقد لا يكون رصيد الدفع هذا ما لديك بالفعل متاحًا للدفع.",
    translated: 'auto',
  ...
  "Step took too long": {
    val: "الخطوة استغرقت وقتًا طويلاً",
    translated: 'auto',
  ...
  "System default": {
    ...
    val: "الإعداد الافتراضي للنظام",
    translated: 'auto',
    h: "A9haWZjRR5Su694Q278jjqi/xmRweA6I6et1Q9L3ahI=",
  },
  "Target date:": {
    val: "التاريخ المستهدف:",
    translated: 'auto',
  ...
  "This budget was upgraded for a newer version of Buckets.  Using it with this older version may not work.": {
    val: "تم ترقية هذا الميزانية للإصدار الأحدث من Buckets. قد لا يعمل استخدامه مع هذا الإصدار القديم.",
    translated: 'auto',
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "لاستخدام Buckets، يجب عليك قبول اتفاقية ترخيص المستخدم النهائي (EULA).",
    translated: 'auto',
    h: "0six0i9oNNM/hjCYct1UTEqdgMn0uoBbaBq0cvnoZLM=",
  },
  "Toggle Developer Tools": {
    val: "تبديل أدوات المطورين",
    translated: 'auto',
    h: "IYSSUL9ezB58nRuajYVa+zH4ucrmXQOB92zA7sDlrJc=",
  },
  "Toggle Full Screen": {
    val: "تبديل الشاشة الكاملة",
    translated: 'auto',
  ...
  "Total amount your buckets want each month.": {
    val: "المبلغ الإجمالي الذي تريده أحواضكم كل شهر.",
    translated: 'auto',
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "استخدام هذه الأداة قد يفسد ملف ميزانيتك. قم بإنشاء نسخة من ميزانيتك إذا كنت قلقًا.",
    translated: 'auto',
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    val: "تحذير: القيام بذلك سيستخدم مطراً لا تمتلكه وقد يسرق مطراً من الأشهر المستقبلية (إذا كان متاحاً).",
    translated: 'auto',
