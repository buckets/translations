...
const messages:IMessages = {
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n        Preferujeme komunikaci vyplněním formuláře, ale můžete nás také kontaktovat na: bugs@budgetwithbuckets.com\n      ",
    translated: true,
  ...
  "(Drop files or click)": {
    val: "(Přetáhněte soubory nebo klikněte)",
    translated: true,
    h: "cn8vjUpkolK+X1qsHPyR11Qj7uQWZVR6eWnhPRb/zfw=",
  },
  "(If you want a response)": {
    val: "(Pokud chcete získat odpověď)",
    translated: true,
  ...
  "Actual Size": {
    val: "Opravdová velikost",
    translated: true,
    h: "k1ZfUj7bmT4XwiALRlZo7ztl2d+e7JcLt3WCnvjpBYg=",
  },
  "Advanced settings": {
    val: "Pokročilé nastavení",
    translated: true,
  ...
  "Amount of money over-allocated in buckets.": {
    val: "Částka peněz nadměrně alokovaná v kbelících.",
    translated: "auto",
  ...
  "Any other monthly bills you have?": {
    val: "Máte nějaké další měsíční platby?",
    translated: "auto",
    h: "rmA9D10bvYOVj3U4kE7U6jALpz7WpqBJTv6HZaI4T/M=",
  },
  "App Settings": {
    val: "Nastavení aplikace",
    translated: "auto",
  ...
  "Attached files are too large.": {
    val: "Připojené soubory jsou příliš velké.",
    translated: "auto",
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "Aveny jsou tím, co používáte k propojení vašich zařízení, abyste mohli poslat svůj rozpočet z jednoho zařízení do druhého.",
    translated: "auto",
  ...
  "Break Import Links": {
    val: "Přerušit importní odkazy",
    translated: "auto",
    h: "XQYKw3qJ7xKoR/DX6K6NdZxbJLHVJhxy9mFVV8r1ZU4=",
  },
  "Bring All to Front": {
    val: "Přenést vše dopředu",
    translated: "auto",
  ...
  "Buckets Budget Filename": {
    /* 'Buckets' refers to the application name */
    /* 'Buckets' refers to the application name */
    val: "Buckets Rozpočet Název souboru",
    translated: "auto",
  ...
  "Buckets has crashed.  Please restart after submitting a bug report.": {
    val: "Buckets se zhavaroval. Prosím, restartujte po odeslání hlášení chyby.",
    translated: "auto",
  ...
  "Budget-specific number format": {
    val: "Formát čísla specifický pro rozpočet",
    translated: "auto",
  ...
  "Can't merge budgets of different versions": {
    val: "Nelze sloučit rozpočty různých verzí",
    translated: "auto",
  ...
  "Choose a file ending in either .ynab4 or .ymeta": {
    val: "Vyberte soubor s příponou .ynab4 nebo .ymeta",
    translated: "auto",
    h: "Tym1GWz52+2AgA4qwsbqknBtvR9QYYGN2y5oYYQ7yZQ=",
  },
  "Choose save location": {
    val: "Vyberte umístění pro uložení",
    translated: "auto",
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "Vyberte, které soubory na tomto zařízení chcete zpřístupnit na vašich ostatních zařízeních.",
    translated: "auto",
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "Spojení je poškozené. Prosím, smazte a znovu vytvořte.",
    translated: "auto",
  ...
  "Create Backup and Start Over": {
    val: "Vytvořit zálohu a Začít znovu",
    translated: "auto",
  ...
  "Do both devices show the same pairing codes?": {
    val: "Zobrazují obě zařízení stejné párovací kódy?",
    translated: "auto",
  ...
  "Duplicate of existing transaction": {
    ...
    val: "Duplikat existující transakce",
    translated: "auto",
  ...
  "Files available to sync": {
    val: "Soubory dostupné k synchronizaci",
    translated: "auto",
  ...
  "Install and Relaunch Buckets": {
    val: "Instalovat a znovu spustit Buckets",
    translated: "auto",
  ...
  "Invalid categorization.  Categories not set.": {
    val: "Neplatná kategorizace. Kategorie nejsou nastaveny.",
    translated: "auto",
  ...
  "Invalid transactions preventing import": {
    val: "Neplatné transakce bránící import",
    translated: "auto",
  ...
  "Keep bucket transactions": {
    val: "Zachovej transakce kbelíků",
    translated: "auto",
    h: "0LwH6beBDlpdXvsVWW7nGj/5/tkz7gDk+Sm4Kltx3rQ=",
  },
  "Keep buckets": {
    val: "Zachovej kbelíky",
    translated: "auto",
  ...
  "Move all transaction memos to blank payee field": {
    val: "Přesunout všechny poznámky k transakcím do prázdného pole pro příjemce",
    translated: "auto",
  ...
  "Nothing found matching:": {
    val: "Nic nenalezeno odpovídající:",
    translated: "auto",
  ...
  "Open Buckets Budget": {
    val: "Otevřít Kbelíky Rozpočet",
    translated: "auto",
    h: "5odppwzoA5bC5nAM3F+GDOVrAq3NfjGxrE0ZFXseCDg=",
  },
  "Open Budget...": {
    val: "Otevřít rozpočet...",
    translated: "auto",
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "Další zařízení zpřístupnila následující soubory. Vyberte, kam je chcete uložit na tomto zařízení.",
    translated: "auto",
  ...
  "Password not yet set": {
    val: "Heslo ještě není nastaveno",
    translated: "auto",
  ...
  "Permanently delete account and transactions": {
    val: "Trvale smazat účet a transakce",
    translated: "auto",
    h: "mSRS1xHHrwwVBuWBlj7RZIGTyGuUy4GwrwOFty5tZrU=",
  },
  "Personal Loan Payment": {
    val: "Platba osobní půjčky",
    translated: "auto",
  ...
  "Please enter your Buckets License below.": {
    val: "Prosím zadejte svou licenci Buckets níže.",
    translated: "auto",
  ...
  "Record change as transaction": {
    val: "Zaznamenej změnu jako transakci",
    translated: "auto",
  ...
  "Remove Categorization": {
    val: "Odstranit Kategorizaci",
    translated: "auto",
    h: "b5sIQMfXAnBAqHD2NJfIgIAxclRGe5LJ7NzzF6sOruQ=",
  },
  "Rent/Mortgage": {
    val: "Pronájem/Hypotéka",
    translated: "auto",
  ...
  "Report Translation Error...": {
    val: "Nahlásit chybu překladu...",
    translated: "auto",
    h: "/jSK7LcBLJ1FsOYb9ntsVYAxwAyGLLUZXlTL/zrC020=",
  },
  "Required deposit:": {
    val: "Požadovaný vklad:",
    translated: "auto",
  ...
  "Show full changelog": {
    val: "Zobrazit úplný záznam změn",
    translated: "auto",
  ...
  "Sign in to the YNAB website, click My Budget then Export Budget.": {
    val: "Přihlaste se na web YNAB, klikněte na Můj rozpočet a poté exportujte rozpočet.",
    translated: "auto",
    h: "etFjjZd2+flhi9J3CbiPL8eb4Gc3jHFAKkMPuQZmxlA=",
  },
  "SimpleFIN Connections": {
    val: "SimpleFIN Připojení",
    translated: "auto",
    h: "yzXdwvSSNy+FUFHW5+bAqRMq+j6krsNUFb/uFreKPNY=",
  },
  "SimpleFIN connection": {
    val: "Spojení SimpleFIN",
    translated: "auto",
  ...
  "Since some buckets have negative balances, this payment balance may not be what you actually have available for a payment.": {
    val: "Protože některé kategorie mají záporné zůstatky, tato platební bilance nemusí být to, co skutečně máte k dispozici pro platbu.",
    translated: "auto",
    h: "DcT2jCu9H9VSH4esyPHz75dbhviMkM3N/TD1N6PtYyM=",
  },
  "Skip This Version": {
    val: "Přeskočit tuto verzi",
    translated: "auto",
  ...
  "This budget was upgraded for a newer version of Buckets.  Using it with this older version may not work.": {
    val: "Tento rozpočet byl upgradován pro novější verzi Buckets.  Používání s touto starší verzí nemusí fungovat.",
    translated: "auto",
    h: "SJjFg0juSV/ZrJcAQJDMXveLnxwSQT4nfJiyMQFkbMw=",
  },
  "This device's name": {
    val: "Název tohoto zařízení",
    translated: "auto",
  ...
  "This will break all existing bank macros": {
    val: "Toto rozbije všechny existující bankovní makra",
    translated: "auto",
    h: "VStGFY84kcqELxtAwamD6vI9ELaA4dZnOs2Ubvwnao8=",
  },
  "Thousands separator": {
    val: "Oddělovač tisíců",
    translated: "auto",
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "K použití Buckets musíte přijmout Licenční smlouvu pro koncového uživatele (EULA).",
    translated: "auto",
    h: "0six0i9oNNM/hjCYct1UTEqdgMn0uoBbaBq0cvnoZLM=",
  },
  "Toggle Developer Tools": {
    val: "Přepnout vývojářské nástroje",
    translated: "auto",
    h: "IYSSUL9ezB58nRuajYVa+zH4ucrmXQOB92zA7sDlrJc=",
  },
  "Toggle Full Screen": {
    val: "Přepnout na celou obrazovku",
    translated: "auto",
  ...
  "Total amount your buckets want each month.": {
    val: "Celková částka, kterou vaše kbelíky chtějí každý měsíc.",
    translated: "auto",
  ...
  "Unexpected sync error": {
    val: "Neočekávaná chyba synchronizace",
    translated: "auto",
  ...
  "Update Target Date": {
    val: "Aktualizovat cílové datum",
    translated: "auto",
    h: "SEac1rQopyHALPSWU85qYV3GE0x9i2OGDB+JYnVID8A=",
  },
  "Update Transaction": {
    val: "Aktualizovat Transakci",
    translated: "auto",
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "Použití tohoto nástroje může poškodit váš soubor rozpočtu. Pokud máte obavy, vytvořte kopii svého rozpočtu.",
    translated: "auto",
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    val: "Varování: Tímto použijete déšť, který nemáte, a mohlo by to ukrást déšť z budoucích měsíců (pokud je dostupný).",
    translated: "auto",
  ...
  "bucket.transfer.help": {
    val: "Převod je transakce z jednoho účtu do druhého. Pokud transakce není příjmem ani výdajem, je to pravděpodobně převod.",
    translated: "auto",
  ...
  "debt-bucket-explanation": {
    val: "Toto je speciální kbelík pro platbu dluhu.",
    translated: "auto",
  ...
  "debt-payment-bucket-name": {
    ...
    val: (account_name:string) => `${account_name} Platba`,
    translated: "auto",
  ...
  "error-detail": {
    val: "Pokud se tato chyba nadále vyskytuje nebo nedává smysl, prosím, nahlaste chybu nebo si promluvte s námi.",
    translated: "auto",
  ...
  "getting-started-link": {
    val: (clickhandler) => {
          return <span>Poprvé používáte Buckets?  Podívejte se na <a href="#" onClick={clickhandler}>Videa pro začátečníky.</a></span>
        },
    translated: "auto",
  ...
  "money-balance-as-of": {
    val: (amount:JSX.Element, date:JSX.Element) => {
                  return <span>{amount} k {date}</span>
                },
    translated: "auto",
    h: "99X4HuXB5SeCrTqn5LuD/S4a6GjUCB6gV1Z1gAZPfKM=",
  },
  "months gain/loss label": {
    val: (gain) => { return gain >= 0 ? "Zisk měsíce" : "Ztráta měsíce"; },
    translated: "auto",
  ...
  "nag-message": {
    val: () => `Toto je neregistrovaná zkušební verze a i přesto, že zkušební verze nemá časové omezení, licence musí být zakoupena pro pokračující použití.

Chcete nyní zakoupit licenci?`,
    translated: "auto",
    h: "cugeP6FVXqdiCtOers5rslG0mDD5t/Rfl1ZWslfhD48=",
  },
  "navigatestep": {
    val: (url) => `Přejít na ${url}`,
    translated: "auto",
    h: "nI/J4GfYlL6BgRZRSiPFfA5o7ASdx2VVYW6x3vgCuKE=",
  },
  "net-transfers.help": {
    val: "Čisté převody jsou součtem všech transakcí označených jako převod. Mělo by to být 0. Pokud to není, proklikněte se, abyste se ujistili, že tam nejsou duplicitní transakce nebo transakce špatně kategorizované jako převody.",
    translated: "auto",
  ...
  "press Escape to close": {
    val: "Stiskněte Escape pro zavření",
    translated: "auto",
  ...
  "rain.help.neg": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Vložili jste {abs_amount} příliš mnoho peněz do košů.  Pokud byly všechny transakce tuto měsíc kategorizovány, odeberte {abs_amount} z košů podle vašeho výběru.
                                      </span>
                                    },
    translated: "auto",
  ...
  "rain.help.pos": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Máte {abs_amount} zbývající k vložení do košů.
                                      </span>
                                    },
    translated: "auto",
  ...
  "sample-size": {
    val: (count:number, total:number) => { return `Zobrazeno ${count} z ${total}` },
    translated: "auto",
  ...
  "simplefin-connect-intro": {
    val: "Pro připojení proveďte následující:",
    translated: "auto",
    h: "421gz/BziKZhsIy2YKRFNtwoqPcbQ7uhFZWWfd6ReBg=",
  },
  "simplefin-get-token": {
    val: (mklink) => {
              return <span>Získejte SimpleFIN Token z {mklink('Most SimpleFIN')}</span>
            },
    translated: "auto",
    h: "VEeKjngcHxowWbB2xWy5oNH4MXIfJQ7EqpiomT6V0fg=",
  },
  "simplefin-paste": {
    val: "Pak vložte svůj SimpleFIN Token zde:",
    translated: "auto",
  ...
  "sync-symbol help": {
    val: "Tento symbol znamená, že transakce pochází z importu/synchronizace",
    translated: "auto",
  ...
  "trans-created-outofview": {
    val: (month: string) => {
              return <span>Transakce vytvořena v {month} </span>;
            },
    translated: "auto",
  ...
  "transfer-from-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Převod z {dropdown}</span>
              },
    translated: "auto",
  ...
  "transfer-to-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Převést na {dropdown}</span>
              },
    translated: "auto",
  ...
  "use-delimiter": {
    ...
    val: (delimiter:string) => `Použij "${delimiter}"`,
    translated: "auto",
