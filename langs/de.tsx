...
const messages:IMessages = {
  ...
  "Budget version is not the same": {
    val: "Budget Version stimmt nicht überein",
    translated: true,
  ...
  "Budgets are too different to merge": {
    val: "Budgets unterscheiden sich zu stark zum Zusammenführen",
    translated: true,
  ...
  "Can't merge with unresolved conflicts": {
    val: "Zusammenführung aufgrund ungelöser Konflikte nicht möglich",
    translated: true,
  ...
  "No orders imported": {
    val: "Keine Aufträge importiert",
    translated: true,
    h: "BSXGKYKVKCk7fbaNo3wAigIjqpZPNfJFNISloGmngZg=",
  },
  "No refunds imported": {
    val: "Keine Rückerstattungen importiert",
    translated: true,
  ...
  "Optionally request an Amazon Refunds report": {
    val: "Wahlweise einen Amazon Rückerstattungsbericht anfordern",
    translated: true,
  ...
  "Search for Amazon transactions:": {
    val: "Nach Amazon-Umsätzen suchen:",
    translated: true,
...
Möchten Sie jetzt eine Lizenz erwerben?`,
  ...
  "shipment-number": {
    ...
    val: (number:number)=>`Sendung ${number}`,
    translated: true,
