...
const messages:IMessages = {
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n        Obwohl das Ausfüllen dieses Formular bevorzugt wird, können Sie auch eine E-Mail an bugs@budgetwithbuckets.com senden\n      ",
    translated: true,
  ...
  "Accept EULA": {
    val: "Endbenutzer-Lizenzvereinbarung akzeptieren",
    translated: true,
  ...
  "Allow new connections": {
    val: "Neue Verbindungen zulassen",
    translated: true,
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "Avenues sind das, was Sie verwenden, um Ihre Geräte miteinander zu verbinden, damit Sie Ihr Budget von einem Gerät zum anderen senden können.",
    translated: "auto",
  ...
  "Budget files are too different to merge": {
    val: "Die Budget-Dateien sind zu unterschiedlich, um zusammengeführt zu werden",
    translated: "auto",
  ...
  "Can't merge budgets of different versions": {
    val: "Budgets verschiedener Versionen können nicht zusammengeführt werden",
    translated: "auto",
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "Wählen Sie aus, welche Dateien auf diesem Gerät Sie für Ihre anderen Geräte verfügbar machen möchten.",
    translated: true,
  ...
  "Create or manage account": {
    ...
    val: "Konto erstellen oder verwalten",
    translated: true,
  ...
  "Do both devices show the same pairing codes?": {
    val: "Zeigen beide Geräte dieselben Pairing-Codes an?",
    translated: true,
  ...
  "Duplicate of existing transaction": {
    ...
    val: "Duplikat einer bestehenden Transaktion",
    translated: true,
    h: "6d7BweiCObuFrgVXiVOkjVaHEKwbPSJY2AbNcT/7508=",
  },
  "EULA accepted": {
    val: "Endbenutzer-Lizenzvereinbarung akzeptiert",
    translated: true,
    h: "MZZW8mGJoOJ5ehMdPPve2szfe+yi7Du06hSKo61py9Y=",
  },
  "EULA not accepted": {
    val: "Endbenutzer-Lizenzvereinbarung nicht akzeptiert",
    translated: true,
  ...
  "Error decrypting recording": {
    val: "Fehler beim Entschlüsseln der Aufzeichnung",
    translated: "auto",
  ...
  "Error during merge": {
    val: "Fehler beim Zusammenführen",
    translated: true,
  ...
  "Error restoring from backup": {
    val: "Fehler beim Wiederherstellen aus der Sicherung",
    translated: true,
    h: "7dtoozbhFD0JBqVUuvIbB6I58faFMyoolWjHqHP7ypo=",
  },
  "Error running macro": {
    val: "Fehler beim Ausführen des Makros",
    translated: "auto",
  ...
  "Error updating transaction": {
    val: "Fehler beim Aktualisieren der Transaktion",
    translated: true,
    h: "IEJfuOO0LRCEv2OUh8Cz02PtiJ8tqVTRzeXK5DyqBQs=",
  },
  "Existing version": {
    val: "Bestehende Version",
    translated: true,
  ...
  "Files available to sync": {
    val: "Dateien verfügbar für die Synchronisierung",
    translated: true,
  ...
  "Finish merge": {
    val: "Zusammenführen abschließen",
    translated: true,
  ...
  "Hide debug info": {
    val: "Debug Informationen verstecken",
    translated: true,
  ...
  "Last sync": {
    val: "Letzte Synchronisierung",
    translated: true,
    h: "ifqkf2oJbmCZakm2f0rOQonkEGgcRhI46mmhSM3tTbA=",
  },
  "Last updated": {
    val: "Zuletzt aktualisiert",
    translated: true,
  ...
  "Local network client": {
    val: "Lokaler Netzwerkclient",
    translated: true,
    h: "bI/iWjtuzv7DVDFzzviehzbWu1TWwURDNt++OVfSXEg=",
  },
  "Local network server": {
    val: "Lokaler Netzwerkserver",
    translated: true,
  ...
  "Memos To Payees": {
    val: "Memos an Zahlungsempfänger",
    translated: "auto",
  ...
  "Move all transaction memos to blank payee field": {
    val: "Verschieben Sie alle Transaktionsnotizen in das leere Empfängerfeld",
    translated: "auto",
  ...
  "No, don't connect": {
    val: "Nein, keine Verbindung herstellen",
    translated: true,
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "Andere Geräte haben die folgenden Dateien verfügbar gemacht. Wählen Sie aus, wo Sie sie auf diesem Gerät speichern möchten.",
    translated: "auto",
  ...
  "Overwrite budget from backup": {
    val: "Budget aus Backup überschreiben",
    translated: "auto",
  ...
  "Password not yet set": {
    val: "Passwort noch nicht gesetzt",
    translated: "auto",
    h: "8NXPDxaFV7KVroTg3YTaO/dWsepbJT/ASSZw9yGeD5g=",
  },
  "Password reset": {
    val: "Passwort zurücksetzen",
    translated: "auto",
  ...
  "Payees": {
    val: "Zahlungsempfänger",
    translated: "auto",
    h: "YjA+7FE+9F3uMVjqhQQyv29+TRFaEMDJfFGbbX1+9aI=",
  },
  "Pending merges": {
    val: "Ausstehende Zusammenführungen",
    translated: true,
  ...
  "Permanently delete account and transactions": {
    val: "Dauerhaft Konto und Transaktionen löschen",
    translated: "auto",
  ...
  "Please enter your Buckets License below.": {
    val: "Bitte geben Sie unten Ihre Buckets-Lizenz ein.",
    translated: true,
  ...
  "Reset bank macro password": {
    val: "Bank-Makro-Passwort zurücksetzen",
    translated: "auto",
  ...
  "Restore from backup": {
    val: "Wiederherstellen aus der Sicherung",
    translated: true,
    h: "4/wBBIqPRkVkrgO1WQ28ED/bEOnF9yg7FMna28aBMC0=",
  },
  "Restored budget from backup": {
    val: "Wiederhergestellt aus der Sicherung",
    translated: true,
  ...
  "Show full changelog": {
    val: "Vollständigen Änderungsverlauf anzeigen",
    translated: true,
  ...
  "Since some buckets have negative balances, this payment balance may not be what you actually have available for a payment.": {
    val: "Da manche Eimer negative Salden haben könnte dies nicht der Betrag sein, den Sie tatsächlich für eine Zahlung zur Verfügung haben.",
    translated: true,
  ...
  "There are unresolved conflicts": {
    val: "Es gibt ungelöste Konflikte",
    translated: "auto",
  ...
  "These devices can talk to each other": {
    val: "Diese Geräte können miteinander kommunizieren",
    translated: "auto",
  ...
  "This budget was upgraded for a newer version of Buckets.  Using it with this older version may not work.": {
    val: "Dieses Budget wurde für eine neue Version von Buckets aktualisiert.  Es mit dieser älteren Version zu benutzen funktioniert möglicherweise nicht.",
    translated: true,
    h: "SJjFg0juSV/ZrJcAQJDMXveLnxwSQT4nfJiyMQFkbMw=",
  },
  "This device's name": {
    val: "Name dieses Gerätes",
    translated: true,
  ...
  "This will break all existing bank macros": {
    val: "Dies wird alle bestehenden Bank-Makros brechen",
    translated: "auto",
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "Um Buckets zu verwenden, müssen Sie die Endbenutzer-Lizenzvereinbarung (EULA) akzeptieren.",
    translated: true,
  ...
  "Total amount your buckets want each month.": {
    val: "Gesamtbetrag, den Ihre Buckets jeden Monat wollen.",
    translated: "auto",
  ...
  "Unattended merge not possible": {
    val: "Unbeaufsichtigtes Zusammenführen nicht möglich",
    translated: "auto",
  ...
  "Unknown account deleted": {
    val: "Unbekanntes Konto gelöscht",
    translated: "auto",
  ...
  "Update Number Format": {
    val: "Zahlenformat ändern",
    translated: true,
    h: "98Qu07eWAHjS80FuHQajrVMMtd0jq5Zq8rRKuDQEZEU=",
  },
  "Update Payee": {
    val: "Zahlungsempfänger aktualisieren",
    translated: "auto",
  ...
  "Update failed": {
    val: "Update fehlgeschlagen",
    translated: "auto",
    h: "MU8WQkSmMfpUADhweg+WSBrhrTcWK23Ow4QqwxyoAfo=",
  },
  "Update opening balance": {
    val: "Eröffnungsbilanz aktualisieren",
    translated: true,
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "Dieses Tool könnte Ihre Budget-Datei zerstören.  Machen Sie vorher eine Sicherungskopie.",
    translated: true,
  ...
  "View EULA": {
    val: "Endbenutzer-Lizenzvereinbarung anzeigen",
    translated: true,
    h: "6symBeYWMFH1ySjpbWX+XjygI3Cq3j/ywz3b0tPtIHE=",
  },
  "Waiting to retry": {
    val: "Warten auf Wiederholung",
    translated: "auto",
  ...
  "You can do math in all number inputs, not just here in the calculator.": {
    val: "Sie können in allen Zahleneingabefeldern Rechnungen ausführen, nicht nur hier im Rechner.",
    translated: true,
  ...
  "buckethead.activity": {
    val: "Nettobilanz von Einnahmen und Ausgaben.",
    translated: "auto",
    h: "Ci5S7xYAKzBYmbK2mxnSj4p0EV9hMsvSs11lDMecqFo=",
  },
  "buckethead.fill": {
    val: "Nettobetrag, der eingezahlt und entnommen wurde (unabhängig von Transaktionen).",
    translated: "auto",
  ...
  "debt-bucket-explanation": {
    val: "Dies ist ein spezieller Schuldenbegleichungs-Eimer.",
    translated: true,
  ...
  "debt-payment-bucket-name": {
    ...
    val: (account_name:string) => `${account_name} Abrechnung`,
    translated: true,
...
Möchten Sie jetzt eine Lizenz erwerben?`,
  ...
  "trans-created-outofview": {
    val: (month: string) => {
              return <span>Umsatz im {month} erzeugt</span>;
            },
    translated: true,
  ...
  "use-delimiter": {
    ...
    val: (delimiter:string) => `"${delimiter}" nutzen`,
    translated: true,
