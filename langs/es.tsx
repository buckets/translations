...
const messages:IMessages = {
  ...
  "Invalid SimpleFIN Token": {
    val: "SimpleFIN Token no es válido",
    translated: true,
  ...
  "New roof": {
    /* I assume Roof is synonymous of "Home" */
    val: "Hogar nuevo",
    translated: true,
  ...
  "No file chosen": {
    val: "No se ha seleccionado ningún archivo",
    translated: true,
  ...
  "Off Budget Accounts": {
    /* I assumed these are tracking accounts for mortage or something like that */
  ...
  "Only select a column for Unique ID if you are sure it contains bank-assigned, unique transaction IDs.  Most CSVs will not have this field.": {
    val: "Seleccione sólo una columna para 'ID Única' si está seguro de que contiene números de ID únicos asignados por el banco para identificar cada transacción. La mayoría de CSV no tienen este campo.",
    translated: true,
  ...
  "Pending devices": {
    val: "Dispositivos pendientes",
    translated: true,
    h: "Er8hgX1RiLPLj22DHMixOaj5wHsWbUM6mL2mdSbt+Sc=",
  },
  "Permanently delete account": {
    val: "Eliminar cuenta de forma permanente",
    translated: true,
  ...
  "Playing": {
     /* I assume Playing is a Category for expenses: "fun money" / "gaming" / "music subscriptions" */
    val: "Diversión",
    translated: true,
  ...
  "Provide a name for the new account.": {
    val: "Proporcione un nombre para la nueva cuenta.",
    translated: true,
  ...
  "Select the account these transactions belong to.": {
    val: "Selecione la cuenta a la que pertenecen estas transacciones.",
    translated: true,
  ...
  "Share from this computer": {
    val: "Compartir desde este ordenador",
    translated: true,
  ...
  "Show uncategorized": {
    val: "Mostrar transacciones sin categoría",
    translated: true,
  ...
  "Update balance without a transaction": {
    val: "Actualizar saldo sin introducir transacción alguna",
    translated: true,
  ...
  "You must have at least one column each set to Amount, Memo and Date Posted.": {
    val: "Debe tener establecidas al menos una columna para cada uno de estos campos: Importe, Nota y Fecha Valor.",
    translated: true,
  ...
  "account-bal-diff-1": {
    val: "El saldo actual no coincide con el existente tras la últiima sincronización por alguno de estos motivos:",
    translated: true,
    h: "9KaivrLeSKn8ROgvad6S9iE9NAz0BZRwQh3/ufRahVA=",
  },
  "account-bal-diff-fix-1": {
    /* 'Buckets' refers to the application name */
    val: "El banco ha informado un saldo a futuro. Para solucionar esto, espere a que todas las transacciones queden reflejadas en Buckets.",
    translated: true,
    h: "CRYYgg8YHspvP5KI3HGvyzlrOhxZf4rrjjUQbmL6Z7Q=",
  },
  "account-bal-diff-fix-2": {
    /* 'Buckets' refers to the application name. */
    val: "Las transacciones ha desaparecido de Buckets.",
    translated: true,
  ...
  "bucketactivity.help": {
    val: "Este es el saldo resultante del dinero sacado de este cubo y de las transferencias a éste desde otros cubos a lo largo del mes.",
    translated: false,
    h: "//A1247jGgumC/yiUDcTLEsXMcwseMWOiaZOpsiMCu0=",
  },
  "buckethead.in": {
    val: "Cantidad de dinero añadida a lo largo del mes.",
    translated: true,
  ...
  "connection-instructions-v2": {
    val: "Proporcione el siguiente enlace URL al otro dispositivo",
    translated: true,
