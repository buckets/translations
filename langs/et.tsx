...
const messages:IMessages = {
  ...
  "Allow new device requests": {
    val: "Luba uute seadmete taotlused",
    translated: true,
  ...
  "Do both devices display the same image and code?": {
    val: "Kas mõlemas seadmes on kuvatud sama pilt ja kood?",
    translated: true,
  ...
  "Enter Buckets License": {
    val: "Sisesta Buckets litsentsikood",
    translated: true,
  ...
  "Total amount your buckets expect each month.": {
    val: "Kogusumma, mida su eelarved iga kuu vajavad.",
    translated: true,
  ...
  "accounts.balance_mismatch_msg": {
    val: "Viimati sünkroonitud saldo ei võrdu kannetest arvutatud saldoga. Klõpsa ... peal, et rohkem infot näha.",
    translated: true,
  ...
  "bucketactivity.help": {
    val: "See on sellel kuul kategooriast väljavõetud raha ja teistest kategooriatest tõstetud raha summa.",
    translated: true,
    h: "//A1247jGgumC/yiUDcTLEsXMcwseMWOiaZOpsiMCu0=",
  },
  "buckethead.in": {
    val: "Sellel kuul sissepandud raha summa.",
    translated: true,
  ...
  "click-to-buy-license": {
    val: "Litsentsi ostmiseks klõpsa siin.",
    translated: true,
    h: "SG8574IFjT8lV9ejaxh3+l1/7egqVVKC59elWkHN3IU=",
  },
  "connection-instructions-v2": {
    val: "Sisesta teises seadmes järgmine kanali URL",
    translated: true,
