...
const messages:IMessages = {
  ...
  "Amount of money over-allocated in buckets.": {
    val: "Kategooriatesse jagatud üleliigne summa.",
    translated: true,
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "Ühenduste abil saad oma eelarvet ühest seadmest teise saata.",
    translated: true,
  ...
  "Can't merge budgets of different versions": {
    val: "Erineva versiooniga eelarveid ei saa mestida",
    translated: true,
  ...
  "Cancel Import": {
    ...
    val: "Katkesta importimine",
    translated: true,
    h: "ASPyW8TypDFl1ANm1SIrpmykDdl3rBQDzC+wk4mdZXA=",
  },
  "Cancel Merge": {
    val: "Katkesta mestimine",
    translated: true,
  ...
  "Choose a file ending in either .ynab4 or .ymeta": {
    val: "Vali fail laiendiga .ynab4 või .ymeta",
    translated: true,
    h: "Tym1GWz52+2AgA4qwsbqknBtvR9QYYGN2y5oYYQ7yZQ=",
  },
  "Choose save location": {
    val: "Vali salvestuskoht",
    translated: true,
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "Vali, milliseid faile selles seadmes soovid teiste seadmetega jagada.",
    translated: true,
  ...
  "Do both devices show the same pairing codes?": {
    val: "Kas mõlemas seadmes kuvatakse sama koodi?",
    translated: true,
  ...
  "Error decrypting recording": {
    val: "Viga salvestuse dekrüpteerimisel",
    translated: true,
  ...
  "Error restoring from backup": {
    val: "Viga varukoopia taastamisel",
    translated: true,
    h: "7dtoozbhFD0JBqVUuvIbB6I58faFMyoolWjHqHP7ypo=",
  },
  "Error running macro": {
    val: "Viga makro käivitamisel",
    translated: true,
  ...
  "File import mapping": {
    ...
    val: "Faili impordi vastendamine",
    translated: true,
  ...
  "Files available to sync": {
    val: "Sünkroonimiseks saadaval failid",
    translated: true,
  ...
  "If Net is 0, the bucket transactions will be marked as transfers rather than as income or expenses.": {
    val: "Kui netosumma on 0, märgitakse eelarve kanded ülekannete, mitte sissetulekute või väljaminekutena.",
    translated: true,
  ...
  "Import all Amazon Reports": {
    val: "Impordi kõik Amazoni aruanded",
    translated: true,
  ...
  "Invalid categorization.  Categories not set.": {
    val: "Vigane liigitus. Kategooriaid ei seatud.",
    translated: true,
  ...
  "Invalid transactions preventing import": {
    val: "Vigased tehingud, mis takistavad importimist",
    translated: true,
  ...
  "Last sync": {
    val: "Viimane sünkroonimine",
    translated: true,
    h: "ifqkf2oJbmCZakm2f0rOQonkEGgcRhI46mmhSM3tTbA=",
  },
  "Last updated": {
    val: "Viimati uuendatud",
    translated: true,
  ...
  "Move all transaction memos to blank payee field": {
    val: "Tõsta kõik tehingute selgitused tühja saaja välja",
    translated: true,
  ...
  "No orders imported": {
    val: "Imporditud tellimusi pole",
    translated: true,
    h: "BSXGKYKVKCk7fbaNo3wAigIjqpZPNfJFNISloGmngZg=",
  },
  "No refunds imported": {
    val: "Imporditud tagasimakseid pole",
    translated: true,
  ...
  "Open Web YNAB Zip File": {
    val: "Ava YNAB veebiversiooni ZIP fail",
    translated: true,
  ...
  "Optionally request an Amazon Refunds report": {
    val: "Taotle Amazon Refunds aruanne",
    translated: true,
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "Teised seadmed on jaganud järgmisi faile. Vali, kuhu soovid need selles seadmes salvestada.",
    translated: true,
  ...
  "Overwrite budget from backup": {
    val: "Kirjuta eelarve varukoopiaga üle",
    translated: true,
  ...
  "Permanently delete account and transactions": {
    val: "Kustuta lõplikult konto ja tehingud",
    translated: true,
  ...
  "Please enter your Buckets License below.": {
    val: "Sisesta allpool oma Bucketsi litsents.",
    translated: true,
  ...
  "Reset bank macro password": {
    val: "Lähtesta panga makro parool",
    translated: true,
  ...
  "Sign in to the YNAB website, click My Budget then Export Budget.": {
    val: "Logi YNAB veebilehel sisse, klõpsa My Budget ja seejärel Export Budget.",
    translated: true,
  ...
  "Since some buckets have negative balances, this payment balance may not be what you actually have available for a payment.": {
    val: "Kuna mõne kategooria saldo on negatiivne, ei pruugi sul makse tegemiseks tegelikult see summa saadaval olla.",
    translated: true,
  ...
  "Sync has not yet been set up.": {
    val: "Sünkroonimine pole veel seadistatud.",
    translated: true,
    h: "B5XIfqqMdt0gMHz2zsZr9GTj9vSRAS5R2akgGce+fsg=",
  },
  "Synced balance": {
    val: "Sünkroonitud saldo",
    translated: true,
  ...
  "These devices can talk to each other": {
    val: "Need seadmed saavad omavahel suhelda",
    translated: true,
  ...
  "This budget was upgraded for a newer version of Buckets.  Using it with this older version may not work.": {
    val: "See eelarve on salvestatud uuema Bucketsi versiooniga ning praeguse vanema versiooniga ei pruugi töötada.",
    translated: true,
  ...
  "This will break all existing bank macros": {
    val: "See teeb katki kõik olemasolevad panga makrod",
    translated: true,
    h: "VStGFY84kcqELxtAwamD6vI9ELaA4dZnOs2Ubvwnao8=",
  },
  "Thousands separator": {
    val: "Tuhandeliste eraldaja",
    translated: true,
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "Bucketsi kasutamiseks pead nõustuma lõppkasutaja litsentsilepinguga.",
    translated: true,
    h: "0six0i9oNNM/hjCYct1UTEqdgMn0uoBbaBq0cvnoZLM=",
  },
  "Toggle Developer Tools": {
    val: "Arendaja tööriistad",
    translated: true,
  ...
  "Total amount your buckets want each month.": {
    val: "Kogusumma, mida su kategooriad igal kuul tahavad.",
    translated: true,
  ...
  "Try the Amazon transactions page instead of using the reports below.": {
    val: "Proovi nende aruannete asemel Amazoni tehingute lehte.",
    translated: true,
  ...
  "Unable to claim access token": {
    val: "Ligipääsuloa pärimine ebaõnnestus",
    translated: true,
  ...
  "Unattended merge not possible": {
    val: "Järelvalveta mestimine pole võimalik",
    translated: true,
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    val: "Hoiatus: Selle tegemine kasutab raha, mida sul veel ei ole, ja võib võtta raha järgmistest kuudest.",
    translated: true,
  ...
  "Web YNAB Export": {
    ...
    val: "YNAB veebiversiooni eksport",
    translated: true,
    h: "tW4h/MIfunRbmUN+oxQ8Sa2pKJQgML5XIcQkPzclpEM=",
  },
  "When \"On\" this macro will be run during a normal sync.": {
    val: "Kui \"Aktiivne\", siis käivitatakse see makro sünkroonimise käigus.",
    translated: true,
  ...
  "You must backup to a different file.": {
    val: "Varukoopia peab salvestama teise faili.",
    translated: true,
  ...
  "bucketinout.help": {
    val: "Kasuta seda kategooriatesse raha sissepanemiseks ja väljavõtmiseks.",
    translated: true,
    h: "FVxtuv3HRHdU7Snx+P3YYxcSngOkrcKyS5mng6AB8gE=",
  },
  "bucketrain.help": {
    val: "See on summa, mida need kategooriad iga kuu vajavad. Väike kast kõrval näitab, kui palju nad on saanud.",
    translated: true,
  ...
  "debt-bucket-explanation": {
    val: "See on spetsiaalne laenu tagasimakse kategooria.",
    translated: true,
...
Kas soovid nüüd litsentsi osta?`,
  ...
  "net-transfers.help": {
    val: "Ülekannete summa on kõigi ülekandena märgitud tehingute kogusumma. See peaks olema 0. Kui ei ole, siis kontrolli, et ei oleks dubleeritud kandeid, või kandeid, mis on ekslikult ülekandeks märgitud.",
    translated: true,
  ...
  "sample-size": {
    val: (count:number, total:number) => {
          return `Kuvatakse ${count} ${total}-st`
        },
    translated: true,
  ...
  "simplefin-get-token": {
    val: (mklink) => {
              return <span>Hangi {mklink('SimpleFIN Bridge')} abil SimpleFIN ligipääsuluba</span>
            },
    translated: true,
    h: "VEeKjngcHxowWbB2xWy5oNH4MXIfJQ7EqpiomT6V0fg=",
  },
  "simplefin-paste": {
    val: "Seejärel kopeeri oma SimpleFIN ligipääsuluba siia:",
    translated: true,
  ...
  "use-delimiter": {
    ...
    val: (delimiter:string) => `Kasuta "${delimiter}"`,
    translated: true,
