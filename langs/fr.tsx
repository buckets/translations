...
const contributors = [
  {
    ...
    href: "https://github.com/Limezy"
  }, {
    name: "Andre Phu-Van Nguyen",
    href: "https://andre-nguyen.github.io"
  }, {
    name: "Steve Jordi",
    href: "https://sjordi.com"
  },
];
...
const messages:IMessages = {
  ...
  "Accounts in side bar": {
    val: "Comptes dans la barre latérale",
    translated: true,
  ...
  "All Files": {
    ...
    /* Label for letting users select any file for import regardless of extension */
    /* Label for letting users select any file for import regardless of extension */
    val: "Tous les fichiers",
    translated: true,
    h: "xP+YqxC7o4/NEWANvugOAGzJXIF368ZNwle6rV7nVRg=",
  },
  "Allow new connections": {
    val: "Autoriser nouvelles connections",
    translated: "auto",
  ...
  "Any other monthly bills you have?": {
    val: "D'autres factures mensuelles?",
    translated: true,
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "Les Avenues sont les moyens de connexions entre vos appareils afin d'envoyer votre budget de l'un à l'autre.",
    translated: "auto",
  ...
  "Break Import Links": {
    val: "Supprimer les liens d'imports",
    translated: true,
  ...
  "Bucket Transaction ID": {
    val: "ID de transaction du godet",
    translated: "auto",
  ...
  "Buckets has crashed.  Please restart after submitting a bug report.": {
    val: "Le godet à planté.  Merci de le relancer après avoir envoyé un rapport de bug.",
    translated: true,
  ...
  "Budget Specific Settings": {
    ...
    val: "Paramètres Spécifiques au Budget",
    translated: true,
  ...
  "Budget files are too different to merge": {
    val: "Les fichiers de budget sont trop différens pour être fusionnées",
    translated: "auto",
    h: "S/vIb5Nknf3NHyuW7Xmh5zS8soTt74dT2/tWCxM5lic=",
  },
  "Budget password:": {
    val: "Mot de passe du budget:",
    translated: true,
    h: "yB5u4awiXu76+/Pw81ZYhBtgYQktcAVe6KU4WreiReU=",
  },
  "Budget-specific number format": {
    val: "Format de nombre spécifique au budget",
    translated: true,
  ...
  "Can't merge budgets of different versions": {
    val: "Impossible de fusionner des budgets de versions différentes",
    translated: "auto",
  ...
  "Cancel Import": {
    ...
    val: "Annuler l'importation",
    translated: true,
    h: "ASPyW8TypDFl1ANm1SIrpmykDdl3rBQDzC+wk4mdZXA=",
  },
  "Cancel Merge": {
    val: "Annuler la fusion",
    translated: "auto",
  ...
  "Check for updates": {
    ...
    val: "Chercher nouvelles versions",
    translated: "auto",
    h: "MerO0fg7nnpQBvZ87GDbTKrOJZo+aGSx6qiQEeVAmXw=",
  },
  "Checking for updates...": {
    val: "Recherche de mises à jour...",
    translated: true,
  ...
  "Choose a file ending in either .ynab4 or .ymeta": {
    val: "Choisissez un fichier finissant en .ynab4 ou .ymeta",
    translated: true,
    h: "Tym1GWz52+2AgA4qwsbqknBtvR9QYYGN2y5oYYQ7yZQ=",
  },
  "Choose save location": {
    val: "Choisir un dossier de sauvegarde",
    translated: "auto",
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "Choisir quels fichiers seront disponibles sur vos autres appareils.",
    translated: "auto",
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "Connexion corrompue. Merci de la supprimer puis de la recréer.",
    translated: true,
    h: "YjH9IxACkJ2e9cq+MYI3I6l3RmOWZPEBAwzjq3W7x0s=",
  },
  "Connection deleted": {
    val: "Connexion supprimée",
    translated: "auto",
  ...
  "Default number format": {
    ...
    val: "Format de nombre par défaut",
    translated: true,
  ...
  "Delete Unknown Account": {
    val: "Supprimer le compte inconnu",
    translated: true,
  ...
  "Do both devices show the same pairing codes?": {
    val: "Les deux appareils affichent le même code?",
    translated: "auto",
  ...
  "Error decrypting recording": {
    val: "Erreur déchiffrement d'enregistrement",
    translated: "auto",
  ...
  "Error restoring from backup": {
    val: "Erreur lors de la restoration du backup",
    translated: "auto",
    h: "7dtoozbhFD0JBqVUuvIbB6I58faFMyoolWjHqHP7ypo=",
  },
  "Error running macro": {
    val: "Erreur lors de l'exécution de la macro",
    translated: "auto",
    h: "obu/8VMe/z+StejTUbzL5fGOP7tMkWw4DfW4KkF/lxs=",
  },
  "Error running recording": {
    val: "Erreur lors de l'exécution de l'enregistrement",
    translated: true,
  ...
  "Error updating transaction": {
    val: "Erreur lors de la mise à jour de la transaction",
    translated: true,
    h: "IEJfuOO0LRCEv2OUh8Cz02PtiJ8tqVTRzeXK5DyqBQs=",
  },
  "Existing version": {
    val: "Version existante",
    translated: "auto",
  ...
  "File import mapping": {
    ...
    val: "Modèle d'import de fichier",
    translated: "auto",
  ...
  "Files available to sync": {
    val: "Fichiers disponibles pour la synchronisation",
    translated: "auto",
  ...
  "Hide debug info": {
    val: "Masquer les infos de débug",
    translated: "auto",
  ...
  "Incoming budget file": {
    val: "Entrée fichier de budget",
    translated: "auto",
    h: "KQwRx6114V/RFL9ilT4S8R+fWFeCu7sLcYe2GcL9JmQ=",
  },
  "Incoming version": {
    val: "Prochaine version",
    translated: "auto",
  ...
  "Invalid transactions preventing import": {
    val: "Transactions invalides à corriger avant l'import",
    translated: true,
  ...
  "Last sync": {
    val: "Dernière synchronisation",
    translated: "auto",
    h: "ifqkf2oJbmCZakm2f0rOQonkEGgcRhI46mmhSM3tTbA=",
  },
  "Last updated": {
    val: "Dernière mise-à-jour",
    translated: "auto",
  ...
  "Move all transaction memos to blank payee field": {
    val: "Déplacer tous les mémos dans les champs bénéficiaires vides",
    translated: "auto",
  ...
  "Or click to download the new version manually.": {
    val: "Ou cliquer pour télécharger une nouvelle version manuellement.",
    translated: true,
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "D'autres fichiers disponibles par d'autres appareils. Choississez où les sauver sur cet appareil.",
    translated: "auto",
  ...
  "Overwrite budget from backup": {
    val: "Ecraser le backup de budget",
    translated: "auto",
    h: "p47XTJ4eKHU3WYE+YwdBvSL80vnN/gn5Xf7C+/gs66U=",
  },
  "Pairing code": {
    val: "Mode d'appairage",
    translated: "auto",
  ...
  "Password not yet set": {
    val: "Mot de passe indéterminé",
    translated: "auto",
    h: "8NXPDxaFV7KVroTg3YTaO/dWsepbJT/ASSZw9yGeD5g=",
  },
  "Password reset": {
    val: "Réinitialiser Mot de passe",
    translated: "auto",
  ...
  "Permanently delete account and transactions": {
    val: "Suppression définitive du compte et ses transactions",
    translated: "auto",
  ...
  "Please enter your Buckets License below.": {
    val: "Introiduisez la licence Buckets ci-dessous.",
    translated: "auto",
  ...
  "Reset bank macro password": {
    val: "Réinitialiser mot de passe macro banque",
    translated: "auto",
  ...
  "Restart Buckets for changes to take effect.": {
    val: "Réinitialiser Buckers pour que les changements prennent effet.",
    translated: true,
    h: "WDqnfUftItQB8zteFdZrFOknNYODkXCwU89Lk/Hs/SQ=",
  },
  "Restore from backup": {
    val: "Récupération à partir de la sauvgarde",
    translated: "auto",
    h: "4/wBBIqPRkVkrgO1WQ28ED/bEOnF9yg7FMna28aBMC0=",
  },
  "Restored budget from backup": {
    val: "Budget récupéré de la sauvegarde",
    translated: "auto",
  ...
  "Set Mapping": {
    ...
    val: "Configurer la mise en relation",
    translated: true,
  ...
  "Sign in to the YNAB website, click My Budget then Export Budget.": {
    val: "Authentifiez-vous sur le site de YNAB, cliquez sur Mon Budget puis Exporter le Budget.",
    translated: true,
  ...
  "Skip invalid": {
    ...
    val: "Ignorer les transactions invalides",
    translated: true,
  ...
  "There are unresolved conflicts": {
    val: "Il y a des conflits non résolus",
    translated: "auto",
  ...
  "These devices can talk to each other": {
    val: "Ces appareils sont capables de communiquer entre eux",
    translated: "auto",
  ...
  "This budget was upgraded for a newer version of Buckets.  Using it with this older version may not work.": {
    val: "Ce budget a été mis à jour pour une version plus récente de Buckets.  L'utiliser avec cette version antérieure pourrait échouer.",
    translated: true,
    h: "SJjFg0juSV/ZrJcAQJDMXveLnxwSQT4nfJiyMQFkbMw=",
  },
  "This device's name": {
    val: "Nom de cet appareil",
    translated: true,
  ...
  "This will break all existing bank macros": {
    val: "Cela va supprimer toutes les macros bancaires",
    translated: "auto",
    h: "VStGFY84kcqELxtAwamD6vI9ELaA4dZnOs2Ubvwnao8=",
  },
  "Thousands separator": {
    val: "Séparateur des milliers",
    translated: true,
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "Vous devez accepter la convention d'usage pour utiliser Buckets",
    translated: "auto",
  ...
  "Total amount your buckets want each month.": {
    val: "Montant total mensuel nécessaire à votre godet.",
    translated: "auto",
  ...
  "Transaction ID": {
    val: "Identifiant de transaction",
    translated: "auto",
    h: "5DaWwSVPo8La/gW0/QWRXAHx08KcbBLOe7BrRuMnKMQ=",
  },
  "Transaction Type": {
    val: "Type de transaction",
    translated: "auto",
  ...
  "Unattended merge not possible": {
    val: "Fusion automatique impossible",
    translated: "auto",
  ...
  "Update Currency Symbol": {
    val: "Mettre à jour Symbole Devise",
    translated: true,
  ...
  "Update Number Format": {
    val: "Mettre à jour le format de nombre",
    translated: true,
    h: "98Qu07eWAHjS80FuHQajrVMMtd0jq5Zq8rRKuDQEZEU=",
  },
  "Update Payee": {
    val: "Mettre à jour le bénéficiaire",
    translated: "auto",
    h: "28JOAeb8QLlBYMLiOO8RGW8SHBJ14Gdp/t/7rprHodk=",
  },
  "Update Payees": {
    val: "Mettre à jour les bénéficiaires",
    translated: "auto",
  ...
  "Update failed": {
    val: "Echec mise à jour",
    translated: "auto",
    h: "MU8WQkSmMfpUADhweg+WSBrhrTcWK23Ow4QqwxyoAfo=",
  },
  "Update opening balance": {
    val: "Mettre à jour le montant initial",
    translated: "auto",
  ...
  "Username": {
    val: "Nom d'utilisateur",
    translated: "auto",
    h: "UAZmOHuQGOos8K4CBGseGzsnoOEV6JPA/VJYYtHu0k8=",
  },
  "Username/Password": {
    val: "Nom d'utilisateur/Mot de passe",
    translated: "auto",
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "Utiliser cet outil peut définitivement endommager votre fichier de budget.  Faites une copie de votre budget si vous pensez qu'il le faut.",
    translated: true,
  ...
  "View EULA": {
    val: "Voir convention d'utilisation",
    translated: "auto",
    h: "6symBeYWMFH1ySjpbWX+XjygI3Cq3j/ywz3b0tPtIHE=",
  },
  "Waiting to retry": {
    val: "En attente de nouvelle tentative",
    translated: "auto",
  ...
  "You can do math in all number inputs, not just here in the calculator.": {
    val: "Vous pouvez effectuer des calculs dans tous les champs numériques, pas uniquement ici dans le calculateur.",
    translated: true,
  ...
  "buckethead.activity": {
    val: "Montant total des revenus et dépenses.",
    translated: "auto",
    h: "Ci5S7xYAKzBYmbK2mxnSj4p0EV9hMsvSs11lDMecqFo=",
  },
  "buckethead.fill": {
    val: "Montant total de dépôts et retraits (sans liens aux transactions).",
    translated: "auto",
  ...
  "debt-bucket-explanation": {
    val: "Ceci est un godet spécial pour le remboursement des dettes",
    translated: true,
  ...
  "debt-payment-bucket-name": {
    ...
    val: (account_name:string) => `${account_name} Remboursements`,
    translated: true,
...
Voudriez-vous acheter une licence maintenant?`,
  ...
  "sample-size": {
    val: (count:number, total:number) => {
          return `${count} visibles parmi ${total}`
        },
    translated: true,
  ...
  "sync.toast.syncing": {
    val: (start: string, end: string) => {
      return `Synchronisation des transactions du ${start} au ${end}`;
      },
    translated: true,
  ...
  "trans-created-outofview": {
    val: (month: string) => {
              return <span>Transaction crée au mois de {month} </span>;
            },
    translated: true,
  ...
  "use-delimiter": {
    ...
    val: (delimiter:string) => `Utiliser "${delimiter}"`,
    translated: true,
