...
const messages:IMessages = {
  ...
  "Allow new device requests": {
    val: "Autoriser l'appairage de nouveaux appareils",
    translated: true,
  ...
  "Break Import Links": {
    val: "Briser les liens d'imports",
    translated: true,
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "Connexion corrompue. Merci de supprimer puis de recréer.",
    translated: true,
  ...
  "Do both devices display the same image and code?": {
    val: "Les deux appareils affichent-ils les mêmes image et code ?",
    translated: true,
  ...
  "Import all Amazon Reports": {
    val: "Importer tous les rapports d'Amazon",
    translated: true,
  ...
  "Invalid transactions preventing import": {
    val: "Transaction invalides à corriger avant l'import",
    translated: true,
  ...
  "No orders imported": {
    val: "Nb ordres importés",
    translated: true,
    h: "BSXGKYKVKCk7fbaNo3wAigIjqpZPNfJFNISloGmngZg=",
  },
  "No refunds imported": {
    val: "Nb remboursements importés",
    translated: true,
  ...
  "Optionally request an Amazon Refunds report": {
    val: "Optionnellement demander un rapport Amazon Refunds",
    translated: true,
  ...
  "Request an Amazon Items report": {
    val: "Demander un rapport d'items Amazon",
    translated: true,
    h: "P4rrDh5nDkcbT6+2mP6w2/DdQS+Hlhu7u/AEo7usOGc=",
  },
  "Request an Amazon Orders report": {
    val: "Demander un rapport de commandes Amazon",
    translated: true,
  ...
  "Search for Amazon transactions:": {
    val: "Rechercher les transations Amazon:",
    translated: true,
  ...
  "Share from this computer": {
    val: "Partager depuis cet ordinateur",
    translated: true,
  ...
  "SimpleFIN client unconfigured": {
    ...
    val: "Client SimpleFIN non configuré",
    translated: true,
  ...
  "click-to-buy-license": {
    val: "Cliquez ici pour acheter une licence.",
    translated: true,
    h: "SG8574IFjT8lV9ejaxh3+l1/7egqVVKC59elWkHN3IU=",
  },
  "connection-instructions-v2": {
    val: "Renseignez l'URL suivante dans l'autre appareil",
    translated: true,
  ...
  "enter-license-prompt": {
    val: "Veuillez entrer votre licence Buckets ci-dessous.",
    translated: true,
  ...
  "match-count": {
    val: (target_match:number, total_matches:number) => {
        return `${target_match} parmi ${total_matches}`;
      },
    translated: true,
...
Voudriez-vous acheter une licence maintenant?`,
  ...
  "shipment-number": {
    ...
    val: (number:number)=>`Envoi ${number}`,
    translated: true,
