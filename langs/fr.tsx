...
const messages:IMessages = {
  ...
  "accounts.balance_mismatch_long_msg": {
    val: () => {
            return (<span>
              ...
              Certaines banques indiquent systématiquement <i>le solde du jour</i> comme le "Solde synchronisé" même quand <i>les transactions du jour</i> n'ont pas encore été envoyées aux buckets.
              Cette incohérence devrait donc se résoudre d'elle-même une fois que l'ensemble des transactions de votre banque auront été synchronisées dans les buckets.
          </span>)},
    translated: false,
  ...
  "balance-as-of": {
    val: (date:JSX.Element) => {
            return <span>à date du {date}</span>
          },
    translated: true,
  ...
  "Total amount your buckets expect each month.": {
    val: "Montant attendu chaque mois par vos buckets.",
    translated: true,
  ...
  "bucketrain.help": {
    val: "Ceci est le montant demandé par chacun de ces buckets tous les mois. La petite jauge indique combien ils ont reçu.",
    translated: true,
    src: ["src/budget/buckets.tsx line 1002"],
  ...
  "bucketactivity.help": {
    val: "Ceci est la somme des montants retirés de ce bucket ainsi que transférés depuis d'autres bucket ce mois-ci.",
    translated: true,
    src: ["src/budget/buckets.tsx line 843"],
  ...
  "This is a special group for all the buckets without a group.": {
    val: "Ce groupe spécial rassemble les buckets n'ayant pas de groupe.",
    translated: true,
  ...
  "Bucket deleted completely": {
    val: "Seau définitivement supprimé",
    translated: true,
  ...
  "bucket.transfer.help": {
    val: "Un transfert est une transaction d'un seau vers un autre. Si la transaction n'est ni un revenu ni une dépense, il s'agit certainement d'un transfert.",
    translated: true,
  ...
  "rain.help.pos": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Vous avez encore {abs_amount} à mettre dans vos seaux.
                                      </span>
                                    },
    translated: true,
  ...
  "rain.help.neg": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Vous avez mis {abs_amount} en trop dans vos seaux.  Si toutes vos transactions du mois ont été catégorisées, enlevez {abs_amount} des seaux de votre choix.
                                      </span>
                                    },
    translated: true,
  ...
  "You don't have any recurring expense buckets yet.": {
    val: "Vous n'avez pas encore de seaux du type dépenses régulières.",
    translated: true,
