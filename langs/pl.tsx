...
const messages:IMessages = {
  ...
  "Only select a column for Unique ID if you are sure it contains bank-assigned, unique transaction IDs.  Most CSVs will not have this field.": {
    val: "Wybierz kolumnę jako ID transakcji, tylko jeśli jesteś pewien, że kolumna zawiera unikalne kody transakcji. Większość plików CSV nie posiada tego pola",
    translated: false,
