...
const messages:IMessages = {
  ...
  "Budget Settings": {
    ...
    val: "Ustawienia programu Budget",
    translated: true,
  ...
  "Import an Amazon Items report to see order details.": {
    val: "Zaimportuj raport Amazon Items aby zobaczyć szczegóły zamówienia.",
    translated: true,
  ...
  "Optionally request a Amazon Refunds report": {
    val: "Opcjonalnie wnioskuj o raport Amazon Refunds",
    translated: true,
  ...
  "bucketactivity.help": {
    val: "To suma pieniędzy wyjęta z tego kubełka i włożona z innych kubełków w tym miesiącu.",
    translated: true,
  ...
  "bucketinout.help": {
    val: "Użyj tej opcji aby włożyć i wyjąć pieniądze do/z każdego kubełka.",
    translated: true,
...
Czy chciałbyś kupić licencję teraz?`,
  ...
  "rain.help.pos": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Zostało {abs_amount} do włożenia do kubełków.
                                      </span>
                                    },
    translated: true,
