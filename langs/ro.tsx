...
const messages:IMessages = {
  ...
  "Any other monthly bills you have?": {
    val: "Ați avea si alte facturi lunare?",
    translated: true,
  ...
  "Delete Macro": {
    val: "Ștergeți macrocomanda",
    translated: true,
    h: "Qb7shd6fRLybaDzPvdr0Z4VfVek/fHVV556kEcNZrH8=",
  },
  "Delete Transactions": {
    val: "Ștergeți tranzacțiile",
    translated: true,
