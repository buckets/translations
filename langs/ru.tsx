...
const messages:IMessages = {
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n        Желательно заполнить эту форму, но вы также можете отправить письмо на bugs@budgetwithbuckets.com\n      ",
    translated: true,
  ...
  "(Drop files or click)": {
    val: "(Перетащите файлы или нажмите)",
    translated: true,
    h: "cn8vjUpkolK+X1qsHPyR11Qj7uQWZVR6eWnhPRb/zfw=",
  },
  "(If you want a response)": {
    val: "(Если вы хотите получить ответ)",
    translated: true,
  ...
  "A sync is already in progress": {
    val: "Синхронизация уже выполняется",
    translated: true,
  ...
  "Actual Size": {
    val: "Фактический размер",
    translated: true,
    h: "k1ZfUj7bmT4XwiALRlZo7ztl2d+e7JcLt3WCnvjpBYg=",
  },
  "Advanced settings": {
    val: "Расширенные настройки",
    translated: 'auto',
  ...
  "Allow new connections": {
    val: "Разрешить новые подключения",
    translated: 'auto',
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "Авеню — это то, что вы используете для соединения ваших устройств вместе, чтобы вы могли отправить свой бюджет с одного устройства на другое.",
    translated: 'auto',
  ...
  "Bucket Transaction ID": {
    val: "Идентификатор транзакции бакета",
    translated: 'auto',
  ...
  "Budget files are too different to merge": {
    val: "Файлы бюджета слишком разные, чтобы объединить",
    translated: 'auto',
  ...
  "Budget-specific number format": {
    val: "Формат числа, специфичный для бюджета",
    translated: 'auto',
  ...
  "Can't merge budgets of different versions": {
    val: "Не удается объединить бюджеты разных версий",
    translated: 'auto',
  ...
  "Change Account Type": {
    val: "Изменить тип счета",
    translated: true,
    h: "elw7uWDm9Vij1azrwiBbY+VwbjMQuo/xziG393BqGUA=",
  },
  "Charity": {
    val: "Благотворительность",
    translated: true,
  ...
  "Choose a file ending in either .ynab4 or .ymeta": {
    val: "Выберите файл с расширением .ynab4 или .ymeta",
    translated: true,
    h: "Tym1GWz52+2AgA4qwsbqknBtvR9QYYGN2y5oYYQ7yZQ=",
  },
  "Choose save location": {
    val: "Выберите место для сохранения",
    translated: 'auto',
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "Выберите, какие из файлов на этом устройстве вы хотите сделать доступными на ваших других устройствах.",
    translated: 'auto',
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "Соединение повреждено. Пожалуйста, удалите и создайте заново.",
    translated: 'auto',
    h: "YjH9IxACkJ2e9cq+MYI3I6l3RmOWZPEBAwzjq3W7x0s=",
  },
  "Connection deleted": {
    val: "Соединение удалено",
    translated: 'auto',
  ...
  "Delete Unknown Account": {
    val: "Удалить неизвестный аккаунт",
    translated: 'auto',
  ...
  "Do both devices show the same pairing codes?": {
    val: "Показывают ли оба устройства одинаковые коды сопряжения?",
    translated: 'auto',
  ...
  "Duplicate of existing transaction": {
    ...
    val: "Дубликат существующей транзакции",
    translated: 'auto',
    h: "6d7BweiCObuFrgVXiVOkjVaHEKwbPSJY2AbNcT/7508=",
  },
  "EULA accepted": {
    val: "Лицензионное соглашение принято",
    translated: 'auto',
  ...
  "EXPERIMENTAL Buckets Macro Maker": {
    /* 'Buckets' refers to the application name */
    val: "ЭКСПЕРИМЕНТАЛЬНЫЙ Buckets Macro Maker",
    translated: 'auto',
  ...
  "Files available to sync": {
    val: "Файлы доступные для синхронизации",
    translated: 'auto',
  ...
  "Hide Others": {
    val: "Скрыть остальные",
    translated: 'auto',
    h: "RpKz0G7Y8OE5oyGm0/zRffPdr7RQkneZCYrikLHIZ+U=",
  },
  "Hide debug info": {
    val: "Скрыть отладочную информацию",
    translated: 'auto',
  ...
  "If Net is 0, the bucket transactions will be marked as transfers rather than as income or expenses.": {
    val: "Если Net равно 0, транзакции корзины будут помечены как переводы, а не как доходы или расходы.",
    translated: 'auto',
  ...
  "Install and Relaunch Buckets": {
    val: "Установить и перезапустить Buckets",
    translated: 'auto',
  ...
  "Invalid categorization.  Categories not set.": {
    val: "Неверная категоризация. Категории не установлены.",
    translated: 'auto',
  ...
  "Invalid transactions preventing import": {
    val: "Недействительные транзакции, препятствующие импорту",
    translated: 'auto',
  ...
  "Local network client": {
    val: "Локальный сетевой клиент",
    translated: 'auto',
    h: "bI/iWjtuzv7DVDFzzviehzbWu1TWwURDNt++OVfSXEg=",
  },
  "Local network server": {
    val: "Локальный сетевой сервер",
    translated: 'auto',
  ...
  "Natural gas/propane/oil": {
    val: "Природный газ/пропан/нефть",
    translated: 'auto',
  ...
  "Nothing found matching:": {
    val: "Ничего не найдено, соответствующее:",
    translated: 'auto',
  ...
  "Open Anyway": {
    ...
    val: "Открыть в любом случае",
    translated: 'auto',
    h: "C3I8WidkzZOLAGX0ypckK7pR7+e/M/X/YVIV1GCTYms=",
  },
  "Open Buckets Budget": {
    val: "Открыть Бакеты Бюджет",
    translated: 'auto',
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "Другие устройства сделали следующие файлы доступными. Выберите, куда вы бы хотели сохранить их на этом устройстве.",
    translated: 'auto',
  ...
  "Overwrite budget from backup": {
    val: "Перезаписать бюджет из резервной копии",
    translated: 'auto',
  ...
  "Paste and Match Style": {
    val: "Вставить и соответствовать стилю",
    translated: 'auto',
  ...
  "Permanently delete account and transactions": {
    val: "Постоянно удалить аккаунт и транзакции",
    translated: 'auto',
    h: "mSRS1xHHrwwVBuWBlj7RZIGTyGuUy4GwrwOFty5tZrU=",
  },
  "Personal Loan Payment": {
    val: "Платеж по личному кредиту",
    translated: 'auto',
  ...
  "Remote device": {
    val: "Удаленное устройство",
    translated: 'auto',
    h: "kGM8ugCEJGdTGfBFNcwYe5BNeXY+Wh9J4nYpxeXj2ZY=",
  },
  "Remote devices": {
    val: "Удаленные устройства",
    translated: 'auto',
  ...
  "Reopen Account": {
    val: "Переоткрыть аккаунт",
    translated: 'auto',
    h: "KBv9ohpTpLSanhr/AFbKdJCA0VZ1iJ0THB53Hut00v4=",
  },
  "Report Bug": {
    val: "Сообщить об ошибке",
    translated: 'auto',
  ...
  "Report Translation Error...": {
    val: "Сообщить об ошибке перевода...",
    translated: 'auto',
    h: "/jSK7LcBLJ1FsOYb9ntsVYAxwAyGLLUZXlTL/zrC020=",
  },
  "Required deposit:": {
    val: "Требуемый депозит:",
    translated: 'auto',
  ...
  "Reset bank macro password": {
    val: "Сбросить пароль макроса банка",
    translated: 'auto',
    h: "aGiRaSU/j/Kke84s+8fSjfD+y1hVndJAUFpywUJVq50=",
  },
  "Restart Buckets": {
    val: "Перезапуск Бакетов",
    translated: 'auto',
  ...
  "Restore from backup": {
    val: "Восстановить из резервной копии",
    translated: 'auto',
    h: "4/wBBIqPRkVkrgO1WQ28ED/bEOnF9yg7FMna28aBMC0=",
  },
  "Restored budget from backup": {
    val: "Восстановлен бюджет из резервной копии",
    translated: 'auto',
  ...
  "Sign in to the YNAB website, click My Budget then Export Budget.": {
    val: "Войдите на сайт YNAB, нажмите Мой бюджет, затем Экспорт бюджета.",
    translated: 'auto',
    h: "etFjjZd2+flhi9J3CbiPL8eb4Gc3jHFAKkMPuQZmxlA=",
  },
  "SimpleFIN Connections": {
    val: "Простые FIN Соединения",
    translated: 'auto',
    h: "yzXdwvSSNy+FUFHW5+bAqRMq+j6krsNUFb/uFreKPNY=",
  },
  "SimpleFIN connection": {
    val: "Подключение SimpleFIN",
    translated: 'auto',
  ...
  "Since some buckets have negative balances, this payment balance may not be what you actually have available for a payment.": {
    val: "Поскольку некоторые корзины имеют отрицательные балансы, этот баланс платежа может не быть тем, что у вас фактически доступно для платежа.",
    translated: 'auto',
    h: "DcT2jCu9H9VSH4esyPHz75dbhviMkM3N/TD1N6PtYyM=",
  },
  "Skip This Version": {
    val: "Пропустить эту версию",
    translated: 'auto',
  ...
  "Step took too long": {
    val: "Шаг занял слишком много времени",
    translated: 'auto',
    h: "Py3rsk0guEg0d8Ce9Lbfwzf1zP7E4Z8YPSOu165mOc0=",
  },
  "Stop Speaking": {
    val: "Прекратить говорить",
    translated: 'auto',
  ...
  "Student Loan Payment": {
    val: "Платеж по студенческому кредиту",
    translated: 'auto',
  ...
  "There are unresolved conflicts": {
    val: "Есть неразрешенные конфликты",
    translated: 'auto',
  ...
  "These devices can talk to each other": {
    val: "Эти устройства могут общаться друг с другом",
    translated: 'auto',
  ...
  "This budget was upgraded for a newer version of Buckets.  Using it with this older version may not work.": {
    val: "Этот бюджет был обновлен для новой версии Buckets. Использование его с этой старой версией может не сработать.",
    translated: 'auto',
    h: "SJjFg0juSV/ZrJcAQJDMXveLnxwSQT4nfJiyMQFkbMw=",
  },
  "This device's name": {
    val: "Имя этого устройства",
    translated: 'auto',
    h: "eTNSTczX466LRmFxprC4rfZhDomB7x4xWYltPshnAB4=",
  },
  "This is a special group for all the buckets without a group.": {
    val: "Это специальная группа для всех бакетов без группы.",
    translated: 'auto',
  ...
  "This will break all existing bank macros": {
    val: "Это сломает все существующие макросы банка",
    translated: 'auto',
    h: "VStGFY84kcqELxtAwamD6vI9ELaA4dZnOs2Ubvwnao8=",
  },
  "Thousands separator": {
    val: "Разделитель тысяч",
    translated: 'auto',
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "Чтобы использовать Buckets, вы должны принять Соглашение об условиях лицензии конечного пользователя (EULA).",
    translated: 'auto',
    h: "0six0i9oNNM/hjCYct1UTEqdgMn0uoBbaBq0cvnoZLM=",
  },
  "Toggle Developer Tools": {
    val: "Переключить инструменты разработчика",
    translated: 'auto',
    h: "IYSSUL9ezB58nRuajYVa+zH4ucrmXQOB92zA7sDlrJc=",
  },
  "Toggle Full Screen": {
    val: "Переключить на полный экран",
    translated: 'auto',
  ...
  "Total amount your buckets want each month.": {
    val: "Общая сумма, которую ваши бакеты хотят каждый месяц.",
    translated: 'auto',
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "Использование этого инструмента может испортить ваш файл бюджета. Сделайте копию вашего бюджета, если вы беспокоитесь.",
    translated: 'auto',
  ...
  "View EULA": {
    val: "Просмотреть EULA",
    translated: 'auto',
    h: "6symBeYWMFH1ySjpbWX+XjygI3Cq3j/ywz3b0tPtIHE=",
  },
  "Waiting to retry": {
    val: "Ожидание повторной попытки",
    translated: 'auto',
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    val: "Предупреждение: Делая это, вы используете дождь, которого у вас нет, и это может украсть дождь из будущих месяцев (если доступно).",
    translated: 'auto',
  ...
  "bucket.transfer.help": {
    val: "Перевод — это транзакция с одного бакета в другой. Если транзакция не является доходом или расходом, то это, вероятно, перевод.",
    translated: 'auto',
  ...
  "debt-bucket-explanation": {
    val: "Это специальный бакет для оплаты долга.",
    translated: 'auto',
  ...
  "debt-payment-bucket-name": {
    ...
    val: (account_name:string) => `${account_name} Платеж`,
    translated: 'auto',
  ...
  "error-detail": {
    val: "Если эта ошибка продолжает происходить или не имеет смысла, пожалуйста, сообщите о баге или пообщайтесь с нами.",
    translated: 'auto',
  ...
  "money-balance-as-of": {
    val: (amount:JSX.Element, date:JSX.Element) => {
                  return <span>{amount} на {date}</span>
                },
    translated: 'auto',
  ...
  "months gain/loss label": {
    val: (gain) => {
                        return gain >= 0 ? "Прибыль месяца" : "Убыток месяца";
                      },
    translated: 'auto',
  ...
  "nag-message": {
    val: () => `Это не зарегистрированная пробная версия, и хотя пробный период не ограничен по времени, лицензия должна быть приобретена для дальнейшего использования.

Хотели бы вы приобрести лицензию сейчас?`,
    translated: 'auto',
  ...
  "net-transfers.help": {
    val: "Чистые переводы являются суммой всех транзакций, помеченных как перевод. Это должно быть 0. Если это не так, перейдите по ссылке, чтобы убедиться, что нет дублирующихся транзакций или транзакций, неправильно отнесенных к переводам.",
    translated: 'auto',
  ...
  "rain.help.neg": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Вы вложили {abs_amount} слишком много денег в бакеты.  Если все транзакции были категоризированы в этом месяце, удалите {abs_amount} из бакетов по вашему выбору.
                                      </span>
                                    },
    translated: 'auto',
  ...
  "rain.help.pos": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      У вас осталось {abs_amount} для размещения в корзинах.
                                      </span>
                                    },
    translated: 'auto',
  ...
  "sample-size": {
    val: (count:number, total:number) => { return `Показаны ${count} из ${total}` },
    translated: 'auto',
  ...
  "simplefin-connect-intro": {
    val: "Чтобы подключиться, сделайте следующее:",
    translated: 'auto',
    h: "421gz/BziKZhsIy2YKRFNtwoqPcbQ7uhFZWWfd6ReBg=",
  },
  "simplefin-get-token": {
    val: (mklink) => {
              return <span>Get a SimpleFIN Token from the {mklink('Мост SimpleFIN')}</span>
            },
    translated: 'auto',
    h: "VEeKjngcHxowWbB2xWy5oNH4MXIfJQ7EqpiomT6V0fg=",
  },
  "simplefin-paste": {
    val: "Затем вставьте ваш токен SimpleFIN здесь:",
    translated: 'auto',
  ...
  "sync-symbol help": {
    val: "Этот символ означает, что транзакция пришла из импорта/синхронизации",
    translated: 'auto',
    h: "S3tDRls+AJYj6f8jSNSCa1FVyNY+ngn6Db1EQJ3dpLE=",
  },
  "sync.toast.syncing": {
    val: (start: string, end: string) => {
        return `Синхронизация транзакций от ${start} до ${end}`;
      },
    translated: 'auto',
  ...
  "trans-created-outofview": {
    val: (month: string) => {
              return <span>Транзакция создана в {month} </span>;
            },
    translated: 'auto',
  ...
  "transfer-from-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Перевод с {dropdown}</span>
              },
    translated: 'auto',
  ...
  "transfer-to-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Передать в {dropdown}</span>
              },
    translated: 'auto',
  ...
  "use-delimiter": {
    ...
    val: (delimiter:string) => `Использовать "${delimiter}"`,
    translated: 'auto',
