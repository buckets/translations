...
const messages:IMessages = {
  ...
  "Click the \"Set mapping\" to continue.": {
    val: "Klicka \"Sätt mappning\" för att fortsätta.",
    translated: true,
  ...
  "Do both devices display the same image and code?": {
    val: "Ser du samma färg och kod på båda enheterna?",
    translated: true,
  ...
  "For Date Posted, you must also choose the date format.": {
    val: "För Postningsdatum måste du även ange datumformat.",
    translated: true,
  ...
  "Identify the data each column contains using the drop downs below.": {
    val: "Identifiera informationen varje kolumn innehåller i menyboxen nedan.",
    translated: true,
  ...
  "If multiple columns are selected for Amount, the first non-zero value will be used.  This is helpful if the CSV contains separate Credit and Debit columns.": {
    val: "Om flera kolumner är valda för Belopp kommer det första värdet som inte är 0 användas.  Detta är användbart om CSV-filen innehåller separata kolumner för debit och kredit.",
    translated: true,
  ...
  "Only select a column for Unique ID if you are sure it contains bank-assigned, unique transaction IDs.  Most CSVs will not have this field.": {
    val: "Välj endast en kolumn för unikt ID om du är säker på att den innehåller bankens genererade unika transaktionsID. De flesta CSV-filer innehåller inte detta fält.",
    translated: true,
  ...
  "Provide a name for the new account.": {
    val: "Ge det nya kontot ett namn.",
    translated: true,
  ...
  "Select the account these transactions belong to.": {
    val: "Välj vilket konto dessa transaktioner avser.",
    translated: true,
  ...
  "SimpleFIN client unconfigured": {
    ...
    val: "SimpleFIN-klient är inte konfigurerad",
    translated: true,
  ...
  "Total amount your buckets expect each month.": {
    val: "Det totala beloppet dina hinkar förväntar sig varje månad.",
    translated: true,
  ...
  "Update balance without a transaction": {
    val: "Uppdatera balans utan transaktion",
    translated: true,
  ...
  "You must have at least one column each set to Amount, Memo and Date Posted.": {
    val: "Du måste ange minst en kolumn var som Summa, Memo och Postningsdatum.",
    translated: true,
  ...
  "account-bal-diff-1": {
    val: "Then löpande balansen matchar inte den senast synkade balansen pga någon av dessa anledningar:",
    translated: true,
    h: "9KaivrLeSKn8ROgvad6S9iE9NAz0BZRwQh3/ufRahVA=",
  },
  "account-bal-diff-fix-1": {
    /* 'Buckets' refers to the application name */
    val: "Banken har rapporterat en framtida balans.  För att åtgärda, vänta tills alla transaktioner har loggats i Buckets.",
    translated: true,
    h: "CRYYgg8YHspvP5KI3HGvyzlrOhxZf4rrjjUQbmL6Z7Q=",
  },
  "account-bal-diff-fix-2": {
    /* 'Buckets' refers to the application name. */
    val: "Transaktioner saknas från Buckets.",
    translated: true,
  ...
  "accounts.balance_mismatch_msg": {
    val: "Den senast synkade balansen matchar inte summan av transaktioner. Klicka på ... för mer information.",
    translated: true,
  ...
  "bucketactivity.help": {
    val: "Detta är summan av pengar som flyttats från denna hink och överföringar till andra hinkar denna månad.",
    translated: true,
    h: "//A1247jGgumC/yiUDcTLEsXMcwseMWOiaZOpsiMCu0=",
  },
  "buckethead.in": {
    val: "Summan pengar som lagts i hinken denna månad.",
    translated: true,
  ...
  "connection-instructions": {
    val: "Ange följande anslutnings-URL till den andra enheten",
    translated: true,
  ...
  "edit.mapping": {
    val: (onClick) => {
          return <span>Eller <a href="#" onClick={onClick}>Editera mappningen.</a></span>
        },
    translated: true,
    h: "hFYUKKIqC+nYQ+RRKwNu3/PGxbtuHzNHoigSJwCK8d4=",
  },
  "enter-license-prompt": {
    val: "\n      Vänligen ange din Buckets Licens nedan.  Har du ingen licens?  <a href=\"#\" id=\"clicktobuy\">Klicka här för att köpa en.</a>\n    ",
    translated: true,
...
Vill du köpa en licens nu?`,
  ...
  "version-available": {
    val: (newv:string) => `Version ${newv} tillgänglig.`,
    translated: true,
