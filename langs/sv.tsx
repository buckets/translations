...
const messages:IMessages = {
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n    Detta formulär är det bästa sättet att rapportera problem, men du kan också maila bugs@budgetwithbuckets.com\n      ",
    translated: true,
  ...
  "(Drop files or click)": {
    val: "(Dra filer hit eller klicka)",
    translated: true,
    h: "cn8vjUpkolK+X1qsHPyR11Qj7uQWZVR6eWnhPRb/zfw=",
  },
  "(If you want a response)": {
    val: "(Om du vill ha återkoppling)",
    translated: true,
  ...
  "A sync is already in progress": {
    val: "Synkronisering pågår redan",
    translated: true,
  ...
  "Amount of money over-allocated in buckets.": {
    val: "Överallokerat belopp i hinkar.",
    translated: true,
  ...
  "Any other monthly bills you have?": {
    val: "Har du några andra månatliga räkningar?",
    translated: true,
    h: "rmA9D10bvYOVj3U4kE7U6jALpz7WpqBJTv6HZaI4T/M=",
  },
  "App Settings": {
    val: "App-inställningar",
    translated: 'auto',
  ...
  "Attached files are too large.": {
    val: "Bifogade filer är för stora.",
    translated: true,
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "Avenuer är vad du använder för att ansluta dina enheter så att du kan skicka din budget från en enhet till en annan.",
    translated: 'auto',
  ...
  "Backups enabled": {
    ...
    val: "Säkerhetskopior aktiverade",
    translated: 'auto',
  ...
  "Basic settings": {
    val: "Grundläggande inställningar",
    translated: 'auto',
  ...
  "Break Import Links": {
    val: "Klipp av Importlänkar",
    translated: true,
    h: "XQYKw3qJ7xKoR/DX6K6NdZxbJLHVJhxy9mFVV8r1ZU4=",
  },
  "Bring All to Front": {
    val: "Sätt Allt Längst Fram",
    translated: true,
  ...
  "Bucket Transaction ID": {
    val: "Behållartransaktions-ID",
    translated: 'auto',
    h: "1bsbXV1Kuxj83UA24XCyscrAKm+nsN+WNbFz1+lf66E=",
  },
  "Bucket Transactions": {
    val: "Hinktransaktioner",
    translated: true,
  ...
  "Buckets has crashed.  Please restart after submitting a bug report.": {
    val: "Buckets har kraschat. Vänligen skicka en felrapport och starta sedan om programmet.",
    translated: true,
  ...
  "Budget files are too different to merge": {
    val: "Budgetfiler är för olika för att slå samman",
    translated: 'auto',
  ...
  "Budget-specific number format": {
    val: "Budgetspecifikt nummerformat",
    translated: true,
  ...
  "Can't merge budgets of different versions": {
    val: "Kan inte slå samman budgetar av olika versioner",
    translated: 'auto',
  ...
  "Cancel Merge": {
    val: "Avbryt Sammanfogning",
    translated: 'auto',
    h: "xOUSd4pIBFhoe1VahnIJgCO8yf46iL9AGSBb3bE9Mvc=",
  },
  "Cancel merge": {
    val: "Avbryt sammanslagning",
    translated: 'auto',
  ...
  "Choose a file ending in either .ynab4 or .ymeta": {
    val: "Välj en fil med filändelse .ynab4 eller .ymeta",
    translated: true,
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "Välj vilka filer på den här enheten du vill göra tillgängliga för dina andra enheter.",
    translated: 'auto',
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "Anslutning korrupt. Vänligen ta bort och skapa om anslutningen. ",
    translated: true,
    h: "YjH9IxACkJ2e9cq+MYI3I6l3RmOWZPEBAwzjq3W7x0s=",
  },
  "Connection deleted": {
    val: "Anslutning raderad",
    translated: 'auto',
  ...
  "Do both devices show the same pairing codes?": {
    val: "Visar båda enheterna samma parningskoder?",
    translated: 'auto',
  ...
  "Duplicate of existing transaction": {
    ...
    val: "Duplikat av befintlig transaktion",
    translated: 'auto',
  ...
  "Error decrypting recording": {
    val: "Fel vid dekryptering av inspelning",
    translated: 'auto',
  ...
  "Error during merge": {
    val: "Fel under sammanslagning",
    translated: 'auto',
    h: "PoE7TMsxGW9dp4u1juziybXV1VV8Wgv9ejdrAoUVynk=",
  },
  "Error fetching data": {
    val: "Fel vid inläsning av data",
    translated: true,
  ...
  "Files available to sync": {
    val: "Filer tillgängliga att synkronisera",
    translated: 'auto',
  ...
  "Hide debug info": {
    val: "Dölj felsökningsinformation",
    translated: 'auto',
  ...
  "If Net is 0, the bucket transactions will be marked as transfers rather than as income or expenses.": {
    val: "Om Netto är 0 kommer transaktionen markeras som överföring istället för inkomst eller utgift.",
    translated: true,
  ...
  "Invalid categorization.  Categories not set.": {
    val: "Ogiltig kategorisering.  Kategorier är inte satta.",
    translated: true,
  ...
  "Local network client": {
    val: "Lokal nätverks klient",
    translated: 'auto',
    h: "bI/iWjtuzv7DVDFzzviehzbWu1TWwURDNt++OVfSXEg=",
  },
  "Local network server": {
    val: "Lokal nätverksserver",
    translated: 'auto',
  ...
  "Memos To Payees": {
    val: "Meddelanden till Mottagare",
    translated: 'auto',
  ...
  "Move all transaction memos to blank payee field": {
    val: "Flytta alla transaktionskommentarer till tomt mottagarfält",
    translated: 'auto',
  ...
  "Need ideas for getting started?": {
    val: "Vill du ha tips för att komma igång?",
    translated: true,
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "Andra enheter har gjort följande filer tillgängliga. Välj var du vill spara dem på den här enheten.",
    translated: 'auto',
  ...
  "Overwrite budget from backup": {
    val: "Överskriv budget från säkerhetskopia",
    translated: 'auto',
  ...
  "Paste and Match Style": {
    val: "Klistra in och Matcha-format",
    translated: true,
  ...
  "Pending merges": {
    val: "Avvaktande sammanslagningar",
    translated: 'auto',
  ...
  "Permanently delete account and transactions": {
    val: "Permanent radera konto och transaktioner",
    translated: 'auto',
    h: "mSRS1xHHrwwVBuWBlj7RZIGTyGuUy4GwrwOFty5tZrU=",
  },
  "Personal Loan Payment": {
    val: "Avbetalning Personlån",
    translated: true,
  ...
  "Please enter your Buckets License below.": {
    val: "Vänligen ange din Buckets-licens nedan.",
    translated: 'auto',
  ...
  "Record change as transaction": {
    val: "Logga ändring som transaktion",
    translated: true,
  ...
  "Show debug info": {
    val: "Visa felsökningsinformation",
    translated: 'auto',
  ...
  "Show full changelog": {
    val: "Visa fullständig ändringslogg",
    translated: 'auto',
  ...
  "Sign in to the YNAB website, click My Budget then Export Budget.": {
    val: "Logga in på YNABs hemsida, klicka på My Budget och sedan Export Budget.",
    translated: true,
    h: "etFjjZd2+flhi9J3CbiPL8eb4Gc3jHFAKkMPuQZmxlA=",
  },
  "SimpleFIN Connections": {
    val: "SimpleFIN-anslutningar",
    translated: true,
    h: "yzXdwvSSNy+FUFHW5+bAqRMq+j6krsNUFb/uFreKPNY=",
  },
  "SimpleFIN connection": {
    val: "SimpleFIN anslutning",
    translated: 'auto',
  ...
  "Since some buckets have negative balances, this payment balance may not be what you actually have available for a payment.": {
    val: "Eftersom några hingar har negativ balans kan denna summa skilja sig från vad du faktiskt har tillgängligt för betalning.",
    translated: true,
    h: "DcT2jCu9H9VSH4esyPHz75dbhviMkM3N/TD1N6PtYyM=",
  },
  "Skip This Version": {
    val: "Hoppa över denna Version",
    translated: true,
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "För att använda Buckets måste du acceptera Slutanvändarlicensavtalet (EULA).",
    translated: 'auto',
    h: "0six0i9oNNM/hjCYct1UTEqdgMn0uoBbaBq0cvnoZLM=",
  },
  "Toggle Developer Tools": {
    val: "Visa Utvecklingsverktyg",
    translated: true,
  ...
  "Total amount your buckets want each month.": {
    val: "Totalt belopp dina hinkar vill ha varje månad.",
    translated: 'auto',
  ...
  "Update Target Date": {
    val: "Uppdatera Måldatum",
    translated: true,
    h: "SEac1rQopyHALPSWU85qYV3GE0x9i2OGDB+JYnVID8A=",
  },
  "Update Transaction": {
    val: "Uppdatera Transaktion",
    translated: true,
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "Användning av detta verktyg kan förstöra din budgetfil. Kör en kopia av din bidget om du är osäker.",
    translated: true,
  ...
  "Waiting to retry": {
    val: "Väntar på att försöka igen",
    translated: 'auto',
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    val: "Varning: Detta kommer använda regn du inte har, och kan stjäla regn från framtida månader (om något finns).",
    translated: true,
  ...
  "When \"On\" this macro will be run during a normal sync.": {
    val: "När \"På\" kommer detta makro köras under en normal synk.",
    translated: true,
  ...
  "bucket.transfer.help": {
    val: "En överföring är en transaktion från en hink till en annan. Om transaktionen inte är en intäkt eller en utgift är den sannolikt en överföring.",
    translated: true,
  ...
  "debt-bucket-explanation": {
    val: "Det här är en speciell hink för skuldbetalning.",
    translated: true,
  ...
  "debt-payment-bucket-name": {
    ...
    val: (account_name:string) => `${account_name} Betalning`,
    translated: true,
  ...
  "error-detail": {
    val: "Om det här felet återkommer eller inte är förståeligt, vänligen skicka en felrapport eller starta en chatt med oss.",
    translated: true,
  ...
  "getting-started-link": {
    val: (clickhandler) => {
          return <span>Är det första gången du använder Buckets?  Kolla in <a href="#" onClick={clickhandler}>Sätta Igång-videos.</a></span>
        },
    translated: true,
  ...
  "money-balance-as-of": {
    val: (amount:JSX.Element, date:JSX.Element) => {
                  return <span>{amount} vid {date}</span>
                },
    translated: true,
  ...
  "months gain/loss label": {
    val: (gain) => {
                        return gain >= 0 ? "Månadens vinst" : "Månadens förlust";
                      },
    translated: true,
  ...
  "nag-message": {
    val: () => `Det här är en oregistrerad provversion, och även om din provperiod saknar slutdatum behöver du köpa en licens för fortsatt användning.

Vill du köpa en licens nu?`,
    translated: true,
  ...
  "net-transfers.help": {
    val: "Nettoöverföringar är summan av alla transaktioner märkta som en överföring.  Den skall vara 0.  Om den inte är det, gå igenom och säkerställ att det inte finns några duplikat eller transaktioner felaktigt kategoriserade som överföringar.",
    translated: true,
  ...
  "notify-downloaded-file": {
    val: filename => `Nedladdad fil: ${filename}`,
    translated: true,
  ...
  "press Escape to close": {
    val: "klicka Escape för att stänga",
    translated: true,
  ...
  "rain.help.neg": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Du har lagt {abs_amount} för mycket i hinkar.  Om alla transaktioner blivit kategoriserade denna månad, ta bort {abs_amount} från några av dina hinkar.
                                      </span>
                                    },
    translated: true,
  ...
  "rain.help.pos": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Du har {abs_amount} kvar att lägga i hinkar.
                                      </span>
                                    },
    translated: true,
  ...
  "simplefin-get-token": {
    val: (mklink) => {
              return <span>Hämta en SimpleFIN Token från {mklink('SimpleFIN Bridge')}</span>
            },
    translated: true,
    h: "VEeKjngcHxowWbB2xWy5oNH4MXIfJQ7EqpiomT6V0fg=",
  },
  "simplefin-paste": {
    val: "Klistra sen in din SimpleFIN Token här:",
    translated: true,
  ...
  "sync-symbol help": {
    val: "Denna symbol innebär att transaktionen kommer från en import/synk",
    translated: true,
    h: "S3tDRls+AJYj6f8jSNSCa1FVyNY+ngn6Db1EQJ3dpLE=",
  },
  "sync.toast.syncing": {
    val: (start: string, end: string) => {
        return `Synkar transaktioner från ${start} till ${end}`;
      },
    translated: true,
  ...
  "toast.updated-trans": {
    val: count => `Ändrat/lagt till ${count} transaktioner`,
    translated: true,
    h: "bBKDE3rQIV5P80cYEL6mkLmIvgxjzVHCIf3aFa+KtmU=",
  },
  "trans-created-outofview": {
    val: (month: string) => {
              return <span>Transaktion skapad i {month} </span>;
            },
    translated: true,
  ...
  "transfer-from-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Överför från {dropdown}</span>
              },
    translated: true,
  ...
  "transfer-to-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Överför till {dropdown}</span>
              },
    translated: true,
  ...
  "use-delimiter": {
    ...
    val: (delimiter:string) => `Använd "${delimiter}"`,
    translated: true,
