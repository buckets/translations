...
const messages:IMessages = {
  ...
  "Account and transactions deleted": {
    val: "Рахунок і транзакції видалено",
    translated: true,
  ...
  "Allow new device requests": {
    val: "Дозволити запити з нових пристроїв",
    translated: true,
  ...
  "Amount of money over-allocated in buckets.": {
    val: "Кількість надлишкових грошей у кошиках.",
    translated: true,
  ...
  "Break Import Links": {
    val: "Розірвати посилання на імпорт",
    translated: true,
  ...
  "Do both devices display the same image and code?": {
    val: "Чи відображають обидва пристрої однакове зображення та код?",
    translated: true,
