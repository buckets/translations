...
const messages:IMessages = {
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n        Хоча заповнення цієї форми бажано, ви також можете надіслати електронний лист на bugs@budgetwithbuckets.com\n      ",
    translated: true,
  ...
  "(Drop files or click)": {
    val: "(Перетягніть файли або натисніть)",
    translated: true,
    h: "cn8vjUpkolK+X1qsHPyR11Qj7uQWZVR6eWnhPRb/zfw=",
  },
  "(If you want a response)": {
    val: "(Якщо ви хочете отримати відповідь)",
    translated: true,
  ...
  "Actual Size": {
    val: "Фактичний розмір",
    translated: true,
    h: "k1ZfUj7bmT4XwiALRlZo7ztl2d+e7JcLt3WCnvjpBYg=",
  },
  "Advanced settings": {
    val: "Розширені налаштування",
    translated: true,
  ...
  "Allow new connections": {
    val: "Дозволити нові підключення",
    translated: true,
  ...
  "Amount of money over-allocated in buckets.": {
    val: "Кількість надлишкових грошей у відрах.",
    translated: true,
  ...
  "Any other monthly bills you have?": {
    val: "Інші щомісячні платежі?",
    translated: true,
    h: "rmA9D10bvYOVj3U4kE7U6jALpz7WpqBJTv6HZaI4T/M=",
  },
  "App Settings": {
    val: "Налаштування додатку",
    translated: true,
  ...
  "Attached files are too large.": {
    val: "Прикріплені файли завеликі.",
    translated: true,
  ...
  "Avenues are what you use to connect your devices together so you can send your budget from one device to another.": {
    val: "Доріжки використовуються для з'єднання ваших пристроїв, так ви зможете надсилати бюджети з одного пристрою на інший.",
    translated: true,
  ...
  "Break Import Links": {
    val: "Розірвати зв'язки для імпорту",
    translated: true,
    h: "XQYKw3qJ7xKoR/DX6K6NdZxbJLHVJhxy9mFVV8r1ZU4=",
  },
  "Bring All to Front": {
    val: "Вивести на передній план",
    translated: true,
  ...
  "Buckets has crashed.  Please restart after submitting a bug report.": {
    val: "Додаток вийшов із ладу. Будь ласка, перезапустіть після подання звіту про помилку.",
    translated: true,
  ...
  "Can't merge budgets of different versions": {
    val: "Не можна об'єднати бюджети різних версій",
    translated: "auto",
  ...
  "Checking for updates...": {
    val: "Перевіряємо наявність оновлень...",
    translated: true,
  ...
  "Choose a file ending in either .ynab4 or .ymeta": {
    val: "Виберіть файл із розширенням .ynab4 або .ymeta",
    translated: true,
    h: "Tym1GWz52+2AgA4qwsbqknBtvR9QYYGN2y5oYYQ7yZQ=",
  },
  "Choose save location": {
    val: "Виберіть місце для збереження",
    translated: true,
  ...
  "Choose which of the files on this device you want to make available to your other devices.": {
    val: "Виберіть, які файли на цьому пристрої мають бути доступні на інших.",
    translated: true,
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "Підключення перервано. Будь ласка, видаліть і створіть заново.",
    translated: true,
    h: "YjH9IxACkJ2e9cq+MYI3I6l3RmOWZPEBAwzjq3W7x0s=",
  },
  "Connection deleted": {
    val: "З'єднання видалено",
    translated: "auto",
    h: "QbB3NfDIpEmXgwY+hq95+aQCRlMErfUvqa+o3tPY93A=",
  },
  "Connection saved!": {
    val: "Підключення збережено!",
    translated: true,
  ...
  "Create budget password:": {
    val: "Захистіть свій бюджет за допомогою пароля:",
    translated: true,
  ...
  "Delete Account": {
    val: "Видалити обліковий запис",
    translated: true,
    h: "zTJTocYLEbNVwJ0ojyPCB6M0JpGx6fe6AZHWtuVJv0M=",
  },
  "Delete Connection": {
    val: "Видалити підключення",
    translated: true,
  ...
  "Do both devices show the same pairing codes?": {
    val: "Чи однаковий код на обох пристроях?",
    translated: true,
  ...
  "Downloading update...": {
    val: "Завантаження оновлення...",
    translated: true,
    h: "vTHXpZeFxjQhKPwUQPCm+eHcyYR6YjSmIm4mtV/5iTE=",
  },
  "Duplicate Window": {
    val: "Скопіювати вікно",
    translated: true,
  ...
  "Duplicate of existing transaction": {
    ...
    val: "Дублікат існуючої транзакції",
    translated: true,
  ...
  "Error running sync": {
    val: "Помилка синхронізації",
    translated: true,
    h: "LB/WNzHp4orPsbCVEJuDzUPsQUfNRDNXw7sFnbzfguw=",
  },
  "Error updating transaction": {
    val: "Помилка оновлення транзакції",
    translated: true,
  ...
  "Files available to sync": {
    val: "Доступні файли для синхронізації",
    translated: true,
  ...
  "Force Reload": {
    val: "Примусове перезавантаження",
    translated: true,
  ...
  "Hide debug info": {
    val: "Сховати інформацію для розробників",
    translated: true,
  ...
  "If Net is 0, the bucket transactions will be marked as transfers rather than as income or expenses.": {
    val: "Якщо Net дорівнює 0, транзакції кошика будуть позначені як перекази, а не як доходи чи витрати.",
    translated: "auto",
  ...
  "Import links broken": {
    ...
    val: "Зв'язки імпорту пошкоджено",
    translated: "auto",
  ...
  "Install and Relaunch Buckets": {
    val: "Встановити та перезапустити Buckets",
    translated: "auto",
  ...
  "Invalid categorization.  Categories not set.": {
    val: "Недійсна категоризація.  Категорії не встановлені.",
    translated: "auto",
  ...
  "Keep bucket transactions": {
    val: "Зберегти транзакції бакета",
    translated: "auto",
    h: "0LwH6beBDlpdXvsVWW7nGj/5/tkz7gDk+Sm4Kltx3rQ=",
  },
  "Keep buckets": {
    val: "Зберігайте відра",
    translated: "auto",
  ...
  "Link Account": {
    val: "Прив'язати обліковий запис",
    translated: "auto",
  ...
  "Local network client": {
    val: "Клієнт локальної мережі",
    translated: "auto",
    h: "bI/iWjtuzv7DVDFzzviehzbWu1TWwURDNt++OVfSXEg=",
  },
  "Local network server": {
    val: "Локальний сервер мережі",
    translated: "auto",
  ...
  "Nothing found matching:": {
    val: "Нічого не знайдено, що відповідає:",
    translated: "auto",
  ...
  "Open Anyway": {
    ...
    val: "Відкрити в будь-якому разі",
    translated: "auto",
    h: "C3I8WidkzZOLAGX0ypckK7pR7+e/M/X/YVIV1GCTYms=",
  },
  "Open Buckets Budget": {
    val: "Відкрити Бакети Бюджет",
    translated: "auto",
  ...
  "Other devices have made the following files available. Choose where you would like to save them on this device.": {
    val: "Інші пристрої зробили доступними такі файли. Виберіть, куди ви хочете зберегти їх на цьому пристрої.",
    translated: "auto",
  ...
  "Overwrite budget from backup": {
    val: "Перезаписати бюджет з резервної копії",
    translated: "auto",
  ...
  "Paste and Match Style": {
    val: "Вставити та узгодити стиль",
    translated: "auto",
  ...
  "Permanently delete account and transactions": {
    val: "Постійно видалити обліковий запис і транзакції",
    translated: "auto",
    h: "mSRS1xHHrwwVBuWBlj7RZIGTyGuUy4GwrwOFty5tZrU=",
  },
  "Personal Loan Payment": {
    val: "Платіж за особистим кредитом",
    translated: "auto",
  ...
  "Please enter your Buckets License below.": {
    val: "Будь ласка, введіть ваш ліцензійний ключ Buckets нижче.",
    translated: "auto",
  ...
  "Remote device": {
    val: "Віддалений пристрій",
    translated: "auto",
    h: "kGM8ugCEJGdTGfBFNcwYe5BNeXY+Wh9J4nYpxeXj2ZY=",
  },
  "Remote devices": {
    val: "Віддалені пристрої",
    translated: "auto",
  ...
  "Reopen Account": {
    val: "Відкрити рахунок",
    translated: "auto",
    h: "KBv9ohpTpLSanhr/AFbKdJCA0VZ1iJ0THB53Hut00v4=",
  },
  "Report Bug": {
    val: "Повідомити про помилку",
    translated: "auto",
  ...
  "Report Translation Error...": {
    val: "Повідомити про помилку перекладу...",
    translated: "auto",
    h: "/jSK7LcBLJ1FsOYb9ntsVYAxwAyGLLUZXlTL/zrC020=",
  },
  "Required deposit:": {
    val: "Необхідний депозит:",
    translated: "auto",
  ...
  "Show Budget File...": {
    ...
    val: "Показати файл бюджету...",
    translated: "auto",
    h: "iMBwVJg17i7WagCWW3Att0OrtczZYyVqAM7PDdo5sXk=",
  },
  "Show Log Files...": {
    val: "Показати файли журналів...",
    translated: "auto",
    h: "In00T9z1A4xO6nLu8zAU5s3UzH3+IcK4XjRvrT9CGMs=",
  },
  "Show debug info": {
    val: "Показати інформацію про налагодження",
    translated: "auto",
  ...
  "Show full changelog": {
    val: "Показати повний журнал змін",
    translated: "auto",
  ...
  "Since some buckets have negative balances, this payment balance may not be what you actually have available for a payment.": {
    val: "Оскільки деякі відра мають від'ємні баланси, цей баланс платежу може не бути тим, що ви фактично маєте доступним для платежу.",
    translated: "auto",
    h: "DcT2jCu9H9VSH4esyPHz75dbhviMkM3N/TD1N6PtYyM=",
  },
  "Skip This Version": {
    val: "Пропустити цю версію",
    translated: "auto",
  ...
  "Step took too long": {
    val: "Крок зайняв забагато часу",
    translated: "auto",
    h: "Py3rsk0guEg0d8Ce9Lbfwzf1zP7E4Z8YPSOu165mOc0=",
  },
  "Stop Speaking": {
    val: "Припиніть говорити",
    translated: "auto",
  ...
  "Student Loan Payment": {
    val: "Платіж за студентським кредитом",
    translated: "auto",
  ...
  "System default": {
    ...
    val: "Системний за замовчуванням",
    translated: "auto",
  ...
  "There was an error.  Maybe try again?": {
    val: "Була помилка. Можливо, спробуйте ще раз?",
    translated: "auto",
    h: "l+W2GSV3tl8Gx19ZW+wOCziBj5/UeMCVO8tvh4P7LEo=",
  },
  "These devices can talk to each other": {
    val: "Ці пристрої можуть спілкуватися один з одним",
    translated: "auto",
  ...
  "This budget was upgraded for a newer version of Buckets.  Using it with this older version may not work.": {
    val: "This budget was upgraded for a newer version of Buckets.  Використання його з цією старішою версією може не працювати.",
    translated: "auto",
    h: "SJjFg0juSV/ZrJcAQJDMXveLnxwSQT4nfJiyMQFkbMw=",
  },
  "This device's name": {
    val: "Назва цього пристрою",
    translated: "auto",
    h: "eTNSTczX466LRmFxprC4rfZhDomB7x4xWYltPshnAB4=",
  },
  "This is a special group for all the buckets without a group.": {
    val: "Це спеціальна група для всіх відер без групи.",
    translated: "auto",
  ...
  "This tool will delete data to make it easy to start over with your budget.": {
    val: "Цей інструмент видалить дані, щоб полегшити початок заново з вашим бюджетом.",
    translated: "auto",
    h: "+40oxGj2jDLNe4ggunYHsgL/9aQz0pw5IeRM5VlYIIU=",
  },
  "This will break all existing bank macros": {
    val: "Це зламає всі існуючі банківські макроси",
    translated: "auto",
    h: "VStGFY84kcqELxtAwamD6vI9ELaA4dZnOs2Ubvwnao8=",
  },
  "Thousands separator": {
    val: "Розділювач тисяч",
    translated: "auto",
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "Щоб використовувати Buckets, ви повинні прийняти Угоду кінцевого користувача про ліцензію (EULA).",
    translated: "auto",
    h: "0six0i9oNNM/hjCYct1UTEqdgMn0uoBbaBq0cvnoZLM=",
  },
  "Toggle Developer Tools": {
    val: "Переключити інструменти розробника",
    translated: "auto",
    h: "IYSSUL9ezB58nRuajYVa+zH4ucrmXQOB92zA7sDlrJc=",
  },
  "Toggle Full Screen": {
    val: "Переключити повноекранний режим",
    translated: "auto",
  ...
  "Total amount your buckets want each month.": {
    val: "Загальна сума, яку ваші відра хочуть кожного місяця.",
    translated: "auto",
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "Використання цього інструменту може зіпсувати ваш файл бюджету. Зробіть копію вашого бюджету, якщо ви стурбовані.",
    translated: "auto",
  ...
  "View EULA": {
    val: "Переглянути EULA",
    translated: "auto",
    h: "6symBeYWMFH1ySjpbWX+XjygI3Cq3j/ywz3b0tPtIHE=",
  },
  "Waiting to retry": {
    val: "Очікування повторної спроби",
    translated: "auto",
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    val: "Попередження: Це використовуватиме дощ, якого у вас немає, і може вкрасти дощ з майбутніх місяців (якщо доступний).",
    translated: "auto",
  ...
  "bank_macro.uuid": {
    ...
    val: "Універсально унікальний ідентифікатор",
    translated: "auto",
  ...
  "bucket.transfer.help": {
    val: "Переказ — це транзакція з одного рахунку в інший. Якщо транзакція не є доходом або витратою, то це, ймовірно, переказ.",
    translated: "auto",
  ...
  "debt-bucket-explanation": {
    val: "Це спеціальний кошик для платежів за борг.",
    translated: "auto",
  ...
  "debt-payment-bucket-name": {
    ...
    val: (account_name:string) => `${account_name} Оплата`,
    translated: "auto",
  ...
  "error-detail": {
    val: "Якщо ця помилка продовжує траплятися або не має сенсу, будь ласка, повідомте про помилку або зв'яжіться з нами.",
    translated: "auto",
  ...
  "getting-started-link": {
    val: (clickhandler) => {
          return <span>Вперше використовуєте Buckets?  Перегляньте <a href="#" onClick={clickhandler}>Відео для початківців.</a></span>
        },
    translated: "auto",
  ...
  "money-balance-as-of": {
    val: (amount:JSX.Element, date:JSX.Element) => {
                  return <span>{amount} станом на {date}</span>
                },
    translated: "auto",
  ...
  "months gain/loss label": {
    val: (gain) => {
                        return gain >= 0 ? "Прибуток місяця" : "Збиток місяця";
                      },
    translated: "auto",
  ...
  "nag-message": {
    val: () => `Це незареєстрована пробна версія, і хоча пробний період необмежений за часом, ліцензію потрібно придбати для подальшого використання. Бажаєте придбати ліцензію зараз?`,
    translated: "auto",
    h: "cugeP6FVXqdiCtOers5rslG0mDD5t/Rfl1ZWslfhD48=",
  },
  "navigatestep": {
    val: (url) => `Перейти до ${url}`,
    translated: "auto",
    h: "nI/J4GfYlL6BgRZRSiPFfA5o7ASdx2VVYW6x3vgCuKE=",
  },
  "net-transfers.help": {
    val: "Чисті перекази є загальною сумою всіх транзакцій, позначених як переказ. Вона повинна бути 0. Якщо ні, натисніть, щоб переглянути та впевнитися, що немає дублікатних транзакцій або транзакцій, неправильно категоризованих як перекази.",
    translated: "auto",
  ...
  "press Escape to close": {
    val: "Натисніть Escape, щоб закрити",
    translated: "auto",
  ...
  "rain.help.neg": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Ви вклали {abs_amount} забагато грошей у кошики.  Якщо всі транзакції цього місяця були категоризовані, видаліть {abs_amount} з кошиків на ваш вибір.
                                      </span>
                                    },
    translated: "auto",
  ...
  "rain.help.pos": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      У вас залишилося {abs_amount} для розміщення в відра.
                                      </span>
                                    },
    translated: "auto",
  ...
  "simplefin-connect-intro": {
    val: "Щоб підключитися, виконайте наступне:",
    translated: "auto",
    h: "421gz/BziKZhsIy2YKRFNtwoqPcbQ7uhFZWWfd6ReBg=",
  },
  "simplefin-get-token": {
    val: (mklink) => {
              return <span>Get a SimpleFIN Token from the {mklink('SimpleFIN Міст')}</span>
            },
    translated: "auto",
    h: "VEeKjngcHxowWbB2xWy5oNH4MXIfJQ7EqpiomT6V0fg=",
  },
  "simplefin-paste": {
    val: "Потім вставте ваш SimpleFIN Token тут:",
    translated: "auto",
  ...
  "sync-symbol help": {
    val: "Цей символ означає, що транзакція надійшла з імпорту/синхронізації",
    translated: "auto",
  ...
  "sync.toast.syncing": {
    ...
    val: (start: string, end: string) => {
        return `Синхронізація транзакцій від ${start} до ${end}`;
      },
    translated: false,
  ...
  "trans-created-outofview": {
    val: (month: string) => {
              return <span>Транзакція створена в {month} </span>;
            },
    translated: "auto",
  ...
  "transfer-from-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Переказ з {dropdown}</span>
              },
    translated: "auto",
  ...
  "transfer-to-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Передати до {dropdown}</span>
              },
    translated: "auto",
  ...
  "use-delimiter": {
    ...
    val: (delimiter:string) => `Використовуйте "${delimiter}"`,
    translated: "auto",
